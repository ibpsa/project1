...
record Buerogebaeude_104 "Buerogebaeude_104"
  extends AixLib.DataBase.ThermalZones.ZoneBaseRecord(
    ...
    nOrientations = 2,
    AWin = {0.0, 3.0},
    ATransparent = {0.0, 3.0},
    hConWin = 0.6,
    RWin = 0.21052631578947367,
    gWin = 0.0,
    UWin= 1.176262492261431,
    ratioWinConRad = 0.0,
    AExt = {15.660000453315995, 0},
    hConExt = 2.7,
    nExt = 1,
    RExt = {0.0017433591096178943},
    RExtRem = 0.11532773158406891 ,
    CExt = {6582995.568535126},
    AInt = 100.580000212176,
    hConInt = 1.7,
    nInt = 1,
    RInt = {0.0005591123029970895},
    CInt = {7322036.030501747},
    AFloor = 0.0,
    hConFloor = 0.0,
    nFloor = 1,
    RFloor = {0.00001},
