...
model DestestOffice_Meeting
  "This is the simulation model of Meeting within building DestestOffice with traceable ID None"
  ...
  thermalZoneTwoElements(
    ...
    AInt=283.3333333333333,
    alphaInt=2.229411764705883,
    nInt=1,
    RInt={0.00017793466678569798},
    CInt={38132457.61752392},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_BuildingSystems/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeMeeting.mat"),
      columns={2,3,4})
