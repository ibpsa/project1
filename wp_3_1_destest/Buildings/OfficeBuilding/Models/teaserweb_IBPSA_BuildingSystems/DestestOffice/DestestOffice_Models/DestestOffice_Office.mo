...
model DestestOffice_Office
  "This is the simulation model of Office within building DestestOffice with traceable ID None"
  ...
  BuildingSystems.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*1483.1542208426329)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=25.0*174.94029583643322)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_BuildingSystems/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeOffice.mat"),
      columns={2,3,4})
