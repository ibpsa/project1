...
model DestestOffice_Storage
  "This is the simulation model of Storage within building DestestOffice with traceable ID None"
  ...
  BuildingSystems.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.001782134105592)
  ...
  BuildingSystems.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*444.9462662527899)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=25.0*52.48208875092997)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_BuildingSystems/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeStorage.mat"),
      columns={2,3,4})
