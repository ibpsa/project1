...
model SupplyNetwork "Only supply line is modelled"
  ...
  IBPSA.Fluid.FixedResistances.Junction jun9(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,1,-1},
    dp_nominal=dP*{1,1,-1})
  ...
  IBPSA.Fluid.FixedResistances.Junction a_sup1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{-1,-1,1},
    dp_nominal=dP*{-1,-1,1})
    annotation (Placement(transformation(extent={{46,144},{66,164}})));
  IBPSA.Fluid.FixedResistances.Junction a_ret1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,1,-1},
    dp_nominal=dP*{1,1,-1})
    annotation (Placement(transformation(extent={{110,136},{130,156}})));
  IBPSA.Fluid.FixedResistances.Junction b_ret_in1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,-1,1},
    dp_nominal=dP*{1,-1,1})
    annotation (Placement(transformation(extent={{110,96},{130,76}})));
  IBPSA.Fluid.FixedResistances.Junction b_ret_out1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,1,-1},
    dp_nominal=dP*{1,1,-1})
    annotation (Placement(transformation(extent={{134,74},{154,94}})));
  IBPSA.Fluid.FixedResistances.Junction b_sup_in1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{-1,-1,1},
    dp_nominal=dP*{-1,-1,1})
    annotation (Placement(transformation(extent={{74,84},{94,104}})));
  IBPSA.Fluid.FixedResistances.Junction b_sup_out1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{-1,1,-1},
    dp_nominal=dP*{-1,1,-1})
    annotation (Placement(transformation(extent={{46,104},{66,84}})));
  IBPSA.Fluid.FixedResistances.Junction c_sup_out1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{-1,1,-1},
    dp_nominal=dP*{-1,1,-1})
    annotation (Placement(transformation(extent={{46,44},{66,24}})));
  IBPSA.Fluid.FixedResistances.Junction c_sup_in1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{-1,-1,1},
    dp_nominal=dP*{-1,-1,1})
    annotation (Placement(transformation(extent={{78,24},{98,44}})));
  IBPSA.Fluid.FixedResistances.Junction c_ret_in1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,-1,1},
    dp_nominal=dP*{1,-1,1})
    annotation (Placement(transformation(extent={{112,36},{132,16}})));
  IBPSA.Fluid.FixedResistances.Junction c_ret_out1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,1,-1},
    dp_nominal=dP*{1,1,-1})
    annotation (Placement(transformation(extent={{136,16},{156,36}})));
  IBPSA.Fluid.FixedResistances.Junction d_sup_out1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{-1,1,-1},
    dp_nominal=dP*{-1,1,-1})
    annotation (Placement(transformation(extent={{46,-16},{66,-36}})));
  IBPSA.Fluid.FixedResistances.Junction d_sup_in1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{-1,-1,1},
    dp_nominal=dP*{-1,-1,1})
    annotation (Placement(transformation(extent={{74,-36},{94,-16}})));
  IBPSA.Fluid.FixedResistances.Junction d_ret_in1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,-1,1},
    dp_nominal=dP*{1,-1,1})
    annotation (Placement(transformation(extent={{110,-24},{130,-44}})));
  IBPSA.Fluid.FixedResistances.Junction d_ret_out1(
    redeclare package Medium = IBPSA.Media.Water,
    m_flow_nominal=m_flow_nominal*{1,1,-1},
    dp_nominal=dP*{1,1,-1})
...
equation
  ...
  connect(hea.port_a, jun9.port_3)
  ...
  connect(c_ret_out.port_1, c_ret_in.port_2)
    annotation (Line(points={{-64,26},{-68,26}}, color={0,127,255}));
  connect(c_ret_in.port_3, b_ret_out.port_3) annotation (Line(points={{-78,36},{
          -78,56},{-56,56},{-56,76}}, color={0,127,255}));
  connect(c_ret_in.port_1, SimpleDistrict_10.port_b) annotation (Line(points={{-88,
          26},{-124,26},{-124,25.8},{-160,25.8}}, color={0,127,255}));
  ...
  connect(d_ret_out.port_3, jun9.port_1) annotation (Line(points={{-56,-44},{-56,
          -146},{-12,-146}}, color={0,127,255}));
  connect(a_ret1.port_2, SimpleDistrict_4.port_b) annotation (Line(points={{130,
          146},{146,146},{146,145.8},{160,145.8}}, color={0,127,255}));
  connect(SimpleDistrict_4.port_a, a_sup1.port_2)
    annotation (Line(points={{160,154},{66,154}}, color={0,127,255}));
  connect(a_sup1.port_1, SimpleDistrict_1.port_a)
    annotation (Line(points={{46,154},{40,154}}, color={0,127,255}));
  connect(a_sup1.port_3, b_sup_out1.port_3)
    annotation (Line(points={{56,144},{56,104}}, color={0,127,255}));
  connect(b_sup_out1.port_1, SimpleDistrict_8.port_a)
    annotation (Line(points={{46,94},{40,94}}, color={0,127,255}));
  connect(b_sup_out1.port_2, b_sup_in1.port_1) annotation (Line(points={{66,94},
          {70,94},{70,94},{74,94}}, color={0,127,255}));
  connect(b_sup_in1.port_2, SimpleDistrict_7.port_a) annotation (Line(points={{94,
          94},{128,94},{128,92},{160,92}}, color={0,127,255}));
  connect(b_ret_in1.port_1, SimpleDistrict_8.port_b) annotation (Line(points={{110,
          86},{76,86},{76,85.8},{40,85.8}}, color={0,127,255}));
  connect(b_ret_in1.port_2, b_ret_out1.port_1) annotation (Line(points={{130,86},
          {132,86},{132,84},{134,84}}, color={0,127,255}));
  connect(b_ret_out1.port_2, SimpleDistrict_7.port_b) annotation (Line(points={{
          154,84},{158,84},{158,83.8},{160,83.8}}, color={0,127,255}));
  connect(b_ret_in1.port_3, a_ret1.port_3)
    annotation (Line(points={{120,96},{120,136}}, color={0,127,255}));
  connect(b_ret_out1.port_3, c_ret_in1.port_3)
    annotation (Line(points={{144,74},{122,74},{122,36}}, color={0,127,255}));
  connect(SimpleDistrict_9.port_a, c_sup_out1.port_1)
    annotation (Line(points={{40,34},{46,34}}, color={0,127,255}));
  connect(c_sup_out1.port_3, b_sup_in1.port_3) annotation (Line(points={{56,44},
          {56,72},{84,72},{84,84}}, color={0,127,255}));
  connect(c_sup_out1.port_2, c_sup_in1.port_1)
    annotation (Line(points={{66,34},{78,34}}, color={0,127,255}));
  connect(c_sup_in1.port_3, d_sup_out1.port_3) annotation (Line(points={{88,24},
          {88,0},{58,0},{58,-16},{56,-16}}, color={0,127,255}));
  connect(d_sup_out1.port_1, SimpleDistrict_14.port_a)
    annotation (Line(points={{46,-26},{40,-26}}, color={0,127,255}));
  connect(d_sup_out1.port_2, d_sup_in1.port_1)
    annotation (Line(points={{66,-26},{74,-26}}, color={0,127,255}));
  connect(SimpleDistrict_14.port_b, d_ret_in1.port_1) annotation (Line(points={{
          40,-34.2},{78,-34.2},{78,-34},{110,-34}}, color={0,127,255}));
  connect(d_sup_in1.port_2, SimpleDistrict_13.port_a) annotation (Line(points={{
          94,-26},{128,-26},{128,-26},{160,-26}}, color={0,127,255}));
  connect(d_ret_in1.port_3, c_ret_out1.port_3) annotation (Line(points={{120,-24},
          {120,6},{146,6},{146,16}}, color={0,127,255}));
  connect(d_ret_in1.port_2, d_ret_out1.port_1) annotation (Line(points={{130,-34},
          {134,-34},{134,-34},{134,-34}}, color={0,127,255}));
  connect(d_ret_out1.port_2, SimpleDistrict_13.port_b) annotation (Line(points={
          {154,-34},{158,-34},{158,-34.2},{160,-34.2}}, color={0,127,255}));
  connect(jun9.port_2, d_ret_out1.port_3) annotation (Line(points={{8,-146},{144,
          -146},{144,-44}}, color={0,127,255}));
  connect(i_sup.port_2, d_sup_in1.port_3)
    annotation (Line(points={{8,-84},{84,-84},{84,-36}}, color={0,127,255}));
  connect(c_sup_in1.port_2, SimpleDistrict_12.port_a)
    annotation (Line(points={{98,34},{160,34}}, color={0,127,255}));
  connect(c_ret_in1.port_2, c_ret_out1.port_1)
    annotation (Line(points={{132,26},{136,26}}, color={0,127,255}));
  connect(c_ret_out1.port_2, SimpleDistrict_12.port_b) annotation (Line(points={
          {156,26},{158,26},{158,25.8},{160,25.8}}, color={0,127,255}));
  connect(c_ret_in1.port_1, SimpleDistrict_9.port_b) annotation (Line(points={{112,
          26},{76,26},{76,25.8},{40,25.8}}, color={0,127,255}));
  connect(a_ret1.port_1, SimpleDistrict_1.port_b) annotation (Line(points={{110,
          146},{76,146},{76,145.8},{40,145.8}}, color={0,127,255}));
  connect(bou.ports[1], d_sup_in1.port_3) annotation (Line(points={{42,-118},{44,
