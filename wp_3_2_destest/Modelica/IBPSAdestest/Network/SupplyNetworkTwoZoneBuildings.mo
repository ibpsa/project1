...
model SupplyNetworkTwoZoneBuildings "Only supply line is modelled"
  extends Modelica.Icons.Example;
  extends IBPSAdestest.Network.BaseClasses.TwoZoneBuildingLocationsDouble(
    SimpleDistrict_2(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_3(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_4(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_5(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_6(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_7(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_8(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_9(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_10(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_11(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_12(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_13(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_14(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_15(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15),
    SimpleDistrict_16(Tsup_prim=T_supply + 273.15, Tret_prim=T_supply - 20 +
          273.15));
  ...
  parameter Real T_supply=67 "T_supply in degC";
...
public
  IBPSA.Fluid.FixedResistances.PlugFlowPipe Supply_11_c(
    ...
    T_start_in=T_supply + 273.15,
    T_start_out=T_supply + 273.15,
    nPorts=1)            annotation (Placement(transformation(extent={{-68,28},{
            -56,40}})));
public
...
public
  IBPSA.Fluid.FixedResistances.PlugFlowPipe Supply_1_e(
    ...
    T_start_in=T_supply + 273.15,
    T_start_out=T_supply + 273.15,
    nPorts=1)             annotation (Placement(transformation(extent={{72,148},
            {60,160}})));
...
public
  IBPSA.Fluid.FixedResistances.PlugFlowPipe Supply_8_f(
    ...
    T_start_in=T_supply + 273.15,
    T_start_out=T_supply + 273.15,
    nPorts=1)             annotation (Placement(transformation(extent={{72,88},{
            60,100}})));
...
equation
  ...
  connect(Supply_2_a.ports_b[1], SimpleDistrict_2.port_a) annotation (Line(
        points={{-140,154},{-172,154},{-172,140}}, color={0,127,255}));
  connect(Return_2_a.port_a, SimpleDistrict_2.port_b) annotation (Line(points={
          {-140,128},{-168,128},{-168,140}}, color={0,127,255}));
  connect(Supply_3_a.ports_b[1], SimpleDistrict_3.port_a) annotation (Line(
        points={{-56,154},{-44,154},{-44,140},{-32,140}}, color={0,127,255}));
  connect(Return_3_a.port_a, SimpleDistrict_3.port_b) annotation (Line(points={
          {-56,128},{-28,128},{-28,140}}, color={0,127,255}));
  connect(SimpleDistrict_1_Building.port_a, Supply_1_e.ports_b[1])
    annotation (Line(points={{28,140},{28,154},{60,154}}, color={0,127,255}));
  connect(SimpleDistrict_1_Building.port_b, Return_1_e.port_a)
    annotation (Line(points={{32,140},{32,128},{60,128}}, color={0,127,255}));
  connect(Supply_5_b.ports_b[1], SimpleDistrict_5.port_a) annotation (Line(
        points={{-140,94},{-154,94},{-154,80},{-168,80}}, color={0,127,255}));
  connect(Return_5_b.port_a, SimpleDistrict_5.port_b) annotation (Line(points={
          {-140,68},{-156,68},{-156,66},{-172,66},{-172,80}}, color={0,127,255}));
  connect(Supply_10_c.ports_b[1], SimpleDistrict_10.port_a) annotation (Line(
        points={{-140,34},{-154,34},{-154,20},{-168,20}}, color={0,127,255}));
  connect(Return_10_c.port_a, SimpleDistrict_10.port_b)
    annotation (Line(points={{-140,8},{-172,8},{-172,20}}, color={0,127,255}));
  connect(Supply_16_d.ports_b[1], SimpleDistrict_16.port_a) annotation (Line(
        points={{-140,-26},{-154,-26},{-154,-40},{-168,-40}}, color={0,127,255}));
  connect(Return_16_d.port_a, SimpleDistrict_16.port_b) annotation (Line(points=
         {{-140,-54},{-156,-54},{-156,-52},{-172,-52},{-172,-40}}, color={0,127,
          255}));
  connect(Return_15_d.port_a, SimpleDistrict_15.port_b) annotation (Line(points=
         {{-56,-54},{-28,-54},{-28,-40}}, color={0,127,255}));
  connect(Supply_15_d.ports_b[1], SimpleDistrict_15.port_a) annotation (Line(
        points={{-56,-26},{-44,-26},{-44,-40},{-32,-40}}, color={0,127,255}));
  connect(Return_11_c.port_a, SimpleDistrict_11.port_b)
    annotation (Line(points={{-56,8},{-28,8},{-28,20}}, color={0,127,255}));
  connect(Supply_11_c.ports_b[1], SimpleDistrict_11.port_a) annotation (Line(
        points={{-56,34},{-46,34},{-46,20},{-32,20}}, color={0,127,255}));
  connect(Return_6_b.port_a, SimpleDistrict_6.port_b)
    annotation (Line(points={{-56,68},{-28,68},{-28,80}}, color={0,127,255}));
  connect(SimpleDistrict_6.port_a, Supply_6_b.ports_b[1]) annotation (Line(
        points={{-32,80},{-44,80},{-44,94},{-56,94}}, color={0,127,255}));
  connect(SimpleDistrict_8.port_a, Supply_8_f.ports_b[1]) annotation (Line(
        points={{32,80},{46,80},{46,94},{60,94}}, color={0,127,255}));
  connect(SimpleDistrict_8.port_b, Return_8_f.port_a)
    annotation (Line(points={{28,80},{28,68},{60,68}}, color={0,127,255}));
  connect(SimpleDistrict_9.port_a, Supply_9_g.ports_b[1]) annotation (Line(
        points={{32,20},{46,20},{46,34},{60,34}}, color={0,127,255}));
  connect(SimpleDistrict_9.port_b, Return_9_g.port_a) annotation (Line(points={
          {28,20},{28,8},{60,8},{60,8}}, color={0,127,255}));
  connect(SimpleDistrict_14.port_a, Supply_14_h.ports_b[1])
    annotation (Line(points={{32,-40},{60,-40},{60,-26}}, color={0,127,255}));
  connect(SimpleDistrict_14.port_b, Return_14_h.port_a)
    annotation (Line(points={{28,-40},{28,-54},{60,-54}}, color={0,127,255}));
  connect(Supply_4_e.ports_b[1], SimpleDistrict_4.port_a) annotation (Line(
        points={{144,154},{156,154},{156,140},{168,140}}, color={0,127,255}));
  connect(Return_4_e.port_a, SimpleDistrict_4.port_b) annotation (Line(points={
          {144,128},{172,128},{172,140}}, color={0,127,255}));
  connect(Supply_7_f.ports_b[1], SimpleDistrict_7.port_a) annotation (Line(
        points={{144,94},{156,94},{156,78},{168,78}}, color={0,127,255}));
  connect(Return_7_f.port_a, SimpleDistrict_7.port_b)
    annotation (Line(points={{144,70},{172,70},{172,78}}, color={0,127,255}));
  connect(Supply_12_g.ports_b[1], SimpleDistrict_12.port_a) annotation (Line(
        points={{144,34},{156,34},{156,20},{168,20}}, color={0,127,255}));
  connect(Return_12_g.port_a, SimpleDistrict_12.port_b) annotation (Line(points=
         {{144,8},{158,8},{158,6},{172,6},{172,20}}, color={0,127,255}));
  connect(Supply_13_h.ports_b[1], SimpleDistrict_13.port_a) annotation (Line(
        points={{144,-26},{156,-26},{156,-40},{168,-40}}, color={0,127,255}));
  connect(Return_13_h.port_a, SimpleDistrict_13.port_b) annotation (Line(points=
         {{144,-54},{172,-54},{172,-40}}, color={0,127,255}));
    annotation (Placement(transformation(extent={{-1,-73},{0,-74}})),
              Diagram(coordinateSystem(extent={{-180,-180},{180,180}})), Icon(
        coordinateSystem(extent={{-100,-100},{100,100}})));
end SupplyNetworkTwoZoneBuildings;
