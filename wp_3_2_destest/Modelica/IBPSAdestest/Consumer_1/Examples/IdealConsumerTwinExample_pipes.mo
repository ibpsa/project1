...
model IdealConsumerTwinExample_pipes
  "Example of idealized twin connection consumer model"
  extends Modelica.Icons.Example;
  IdealConsumerTwin_pipes
                    con(
  ...
  Modelica.Blocks.Sources.RealExpression realExpression(y=273.15 + 12)
...
equation
  ...
  connect(realExpression.y, con.T_a) annotation (Line(points={{3,24},{12,24},{12,
          18},{20,18}}, color={0,0,127}));
  connect(con.T_b, con.T_a) annotation (Line(points={{20,9},{6,9},{6,24},{12,24},
          {12,18},{20,18}}, color={0,0,127}));
...
<br/>First implementation</li>
        ...
        "Simulate and plot"));
end IdealConsumerTwinExample_pipes;
