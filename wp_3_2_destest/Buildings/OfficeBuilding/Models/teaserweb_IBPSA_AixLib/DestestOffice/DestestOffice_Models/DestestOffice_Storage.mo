...
within teaserweb_IBPSA_AixLib.DestestOffice.DestestOffice_Models;
model DestestOffice_Storage
  ...
  AixLib.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam="modelica://teaserweb_IBPSA_AixLib/DestestOffice/DEU_BW_Mannheim_107290_TRY2010_12_Jahr_BBSR.mos")
    "Weather data reader"
  ...
  AixLib.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[6](    til={1.5707963267948966, 0.0, 1.5707963267948966, 1.5707963267948966, 0.0, 1.5707963267948966},
    each lat =  0.88645272708792,
    azi={0.0, 0.0, 3.141592653589793, -1.5707963267948966, 0.0, 1.5707963267948966})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  AixLib.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.001782134105592)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_AixLib/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeStorage.mat"),
      columns={2,3,4})
