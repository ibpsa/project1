...
model DestestOffice_Storage
  ...
  IDEAS.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.001782134105592)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_IDEAS/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeStorage.mat"),
      columns={2,3,4})
