...
within teaserweb_IBPSA_Buildings.DestestOffice.DestestOffice_Models;
model DestestOffice_Restroom
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam="modelica://teaserweb_IBPSA_Buildings/DestestOffice/DEU_BW_Mannheim_107290_TRY2010_12_Jahr_BBSR.mos")
    "Weather data reader"
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_Buildings/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeRestroom.mat"),
      columns={2,3,4})
