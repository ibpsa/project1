...
within teaserweb_IBPSA_BuildingSystems.DestestOffice.DestestOffice_Models;
model DestestOffice_Restroom
  "This is the simulation model of Restroom within building DestestOffice with traceable ID None"
  ...
  BuildingSystems.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam="modelica://teaserweb_IBPSA_BuildingSystems/DestestOffice/DEU_BW_Mannheim_107290_TRY2010_12_Jahr_BBSR.mos")
    "Weather data reader"
    annotation (Placement(transformation(extent={{-98,52},{-78,72}})));
  BuildingSystems.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[6](    each outSkyCon=true,
    each outGroCon=true,
  ...
  BuildingSystems.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[6](    til={1.5707963267948966, 0.0, 1.5707963267948966, 1.5707963267948966, 0.0, 1.5707963267948966},
    each lat =  0.88645272708792,
    azi={0.0, 0.0, 3.141592653589793, -1.5707963267948966, 0.0, 1.5707963267948966})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  BuildingSystems.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.001782134105591)
  ...
  BuildingSystems.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
  ...
  BuildingSystems.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*118.65233766741063)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=25.0*13.995223666914658)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_BuildingSystems/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeRestroom.mat"),
      columns={2,3,4})
