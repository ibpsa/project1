...
model DestestOffice_ICT
  "This is the simulation model of ICT within building DestestOffice with traceable ID None"
  ...
  BuildingSystems.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*59.32616883370532)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=25.0*6.997611833457329)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
      ...
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://teaserweb_IBPSA_BuildingSystems/DestestOffice/DestestOffice_Models/InternalGains_DestestOfficeICT.mat"),
      columns={2,3,4})
