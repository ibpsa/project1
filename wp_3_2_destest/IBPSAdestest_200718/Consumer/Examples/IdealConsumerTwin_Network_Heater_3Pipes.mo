...
model IdealConsumerTwin_Network_Heater_3Pipes
...
equation
  ...
  connect(con1.port_b, hea1.port_a) annotation (Line(points={{-90,55.8},{-76,
          55.8},{-76,10},{-40,10}}, color={0,127,255}));
...
end IdealConsumerTwin_Network_Heater_3Pipes;
