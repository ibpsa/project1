...
model IdealConsumerTwin_Network_Heater_Pipe
...
equation
  ...
  connect(pipeba.ports_b[1], senEntFloIn.port_a)
    annotation (Line(points={{-40,56},{-40,64},{40,64}}, color={0,127,255}));
...
end IdealConsumerTwin_Network_Heater_Pipe;
