within IBPSAdestest_200718.Network_with_Parameters;
model SupplyNetwork_Pipes_BHEX "Only supply line is modelled"
  ...
  Buildings.Fluid.HeatExchangers.Ground.Boreholes.UTube borehole(
    m_flow_nominal=0.14,
    dp_nominal=1000,
    samplePeriod=31536000,
    matSoi(
      k=1000,
      c=1500,
      d=1100),
...
equation
  ...
  connect(pipecSD10.heatPort, pipeSD16d.heatPort) annotation (Line(points={{
          ...
          {-128,-36},{-128,-56},{-140,-56},{-140,-44}}, color={191,0,0}));
  connect(bou.ports[1], pipehi.port_a) annotation (Line(points={{32,-53.3333},{
          32,-152},{106,-152},{106,-54}},
                                       color={0,127,255}));
  connect(pipeih.port_a, pipeid.port_a) annotation (Line(points={{94,-46},{94,
          -100},{-106,-100},{-106,-46}}, color={0,127,255}));
  connect(pipedi.port_a, bou.ports[2]) annotation (Line(points={{-94,-54},{-94,
          -150},{32,-150},{32,-56}}, color={0,127,255}));
  connect(borehole.port_b, pipeid.port_a) annotation (Line(points={{-25,-112},{
          -25,-100},{-106,-100},{-106,-46}}, color={0,127,255}));
  connect(borehole.port_a, bou.ports[3]) annotation (Line(points={{-25,-142},{
          -22,-142},{-22,-150},{32,-150},{32,-58.6667}}, color={0,127,255}));
  annotation (Diagram(coordinateSystem(extent={{-180,-180},{180,180}})), Icon(
        coordinateSystem(extent={{-100,-100},{100,100}})));
end SupplyNetwork_Pipes_BHEX;
