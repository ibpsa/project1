...
equation
  ...
  connect(realExpression.y, hea1.TSet) annotation (Line(points={{-27,-134},{-16,
          -134},{-16,-136},{-12,-136},{-12,-126}}, color={0,0,127}));
  connect(hea1.port_b, pipeid.port_a) annotation (Line(points={{-4,-104},{-56,
          -104},{-56,-46},{-106,-46}}, color={0,127,255}));
  connect(hea1.port_b, pipeih.port_a) annotation (Line(points={{-4,-104},{46,
          -104},{46,-46},{94,-46}}, color={0,127,255}));
  connect(hea1.port_a, pipehi.port_a) annotation (Line(points={{-4,-124},{-4,
          -152},{106,-152},{106,-54}},           color={0,127,255}));
  connect(hea1.port_a, pipedi.port_a) annotation (Line(points={{-4,-124},{-4,
          -152},{-98,-152},{-98,-54},{-94,-54}},           color={0,127,255}));
