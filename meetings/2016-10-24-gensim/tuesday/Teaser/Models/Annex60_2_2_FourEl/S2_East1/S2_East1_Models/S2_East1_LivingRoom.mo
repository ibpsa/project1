...
model S2_East1_LivingRoom
  ...
  thermalZoneFourElements(
    ...
    RExtRem=0.0099762911819,
    AFloor=58.3,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.000542614632591},
    RFloorRem=0.0023425874757,
    CFloor={8605474.87654},
    ARoof=0.0,
    alphaRoof=0.001,
    nRoof=1,
    RRoof={1e-05},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.5032761185030349, 0.29147405233750046, 0.2052498291594645},
    wfWin={0.37649743297204785, 0.4968625213918996, 0.12664004563605247},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
