...
model S2_East1_TrafficArea
  "This is the simulation model of S2_East1_TrafficArea"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[1](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966},
    each lat = 0.8861990609344351,
    azi={1.5707963267948966})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  Annex60.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[1](
    til={1.5707963267948966},
    each lat = 0.8861990609344351,
    azi={1.5707963267948966})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=1, UWin=5.003248862897985)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00430370892857},
    CExt={1683199.81548},
    alphaRad=2.231037996797205,
    AInt=45.648,
    alphaInt=11.167731335436383,
    nInt=1,
    RInt={0.00172262893227},
    CInt={7880469.1514},
    RWin=0.109375,
    RExtRem=0.0489507289413,
    AFloor=18.3,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.00172865754536},
    RFloorRem=0.00746299725864,
    CFloor={2701203.94924},
    ARoof=7.7,
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.000678363336028},
    RRoofRem=0.031622668965,
    CRoof={221708.327757},
  ...
  *10.14)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=16.0)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=192.5)
