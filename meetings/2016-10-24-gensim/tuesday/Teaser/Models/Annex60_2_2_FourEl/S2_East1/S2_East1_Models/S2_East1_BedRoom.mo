within Annex60_2_2_FourEl.S2_East1.S2_East1_Models;
model S2_East1_BedRoom
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00073765396443},
    CExt={9820325.55069},
    alphaRad=3.0304036479950414,
    AInt=71.182,
    ...
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.000122614969188},
    RRoofRem=0.00571583453123,
    CRoof={1226594.12499},
    ...
    nOrientations=3,
    AWin={5.76, 2.0, 0.0},
    ATransparent={5.76, 2.0, 0.0},
    AExt={25.88, 21.212, 12.068}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.4374577417173766, 0.3585530764029749, 0.2039891818796484},
    wfWin={0.7422680412371134, 0.2577319587628866, 0.0},
    withLongwave=true,
  ...
  *59.16)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1065.0)
