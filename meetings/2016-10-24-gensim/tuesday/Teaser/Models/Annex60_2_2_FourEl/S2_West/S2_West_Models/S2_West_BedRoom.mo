within Annex60_2_2_FourEl.S2_West.S2_West_Models;
model S2_West_BedRoom
  ...
  thermalZoneFourElements(
    ...
    nOrientations=3,
    AWin={5.76, 0.0, 2.0},
    ATransparent={5.76, 0.0, 2.0},
    AExt={25.88, 12.068, 21.212}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.4374577417173766, 0.2039891818796484, 0.3585530764029749},
    wfWin={0.7422680412371134, 0.0, 0.2577319587628866},
    withLongwave=true,
