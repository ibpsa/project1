...
model S1_East1_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of S1_East1_WCandsanitaryroomsinnonresidentialbuildings"
  ...
  thermalZoneFourElements(
    ...
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.0462304001174},
    RRoofRem=0.419300043674,
    CRoof={810166.198377},
  ...
  *10.144)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=172.49999999999997)
...
equation
  ...
  StopTime=31536000,
  Interval=3600));
end S1_East1_WCandsanitaryroomsinnonresidentialbuildings;
