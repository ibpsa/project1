...
model S1_East1_LivingRoom
  "This is the simulation model of S1_East1_LivingRoom"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00154938574283},
    CExt={9490087.65503},
    alphaRad=3.1951313834442616,
    AInt=70.94,
    alphaInt=14.808753876515365,
    nInt=1,
    RInt={0.000988403460395},
    CInt={12366226.2505},
    RWin=0.0263007776143,
    RExtRem=0.0453287045724,
    AFloor=58.3,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.000706286504901},
    RFloorRem=0.0390066827308,
    CFloor={5313769.04473},
    ARoof=0.0,
    alphaRoof=0.001,
    nRoof=1,
    RRoof={1e-05},
    ...
    nOrientations=3,
    AWin={8.71, 6.6, 2.22},
    ATransparent={8.71, 6.6, 2.22},
    AExt={14.502, 25.04, 10.212}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.2914740523375005, 0.503276118503035, 0.20524982915946455},
    wfWin={0.4968625213918997, 0.3764974329720479, 0.1266400456360525},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
  ...
  *49.754000000000005)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=438.25)
