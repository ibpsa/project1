...
model S2_North_R1_BedRoom
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi={3.141592653589793, 0.0, 1.5707963267948966})
  ...
  thermalZoneFourElements(
    ...
    nOrientations=3,
    AWin={2.0, 0.0, 5.76},
    ATransparent={2.0, 0.0, 5.76},
    AExt={21.212, 12.068, 25.88}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.3585530764029749, 0.2039891818796484, 0.4374577417173766},
    wfWin={0.2577319587628866, 0.0, 0.7422680412371134},
    withLongwave=true,
