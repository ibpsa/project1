...
model A1_North1_BedRoom
  "This is the simulation model of A1_North1_BedRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=1, UWin=1.692268542081155)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.000669632889581},
    CExt={21958011.2322},
    alphaRad=2.9267541156791967,
    AInt=188.4,
    ...
    RExtRem=0.0195907259147,
    AFloor=56.82,
    alphaFloor=2.6999999999999997,
    nFloor=1,
    RFloor={0.000724683267084},
    RFloorRem=0.0400226962902,
    CFloor={5178874.05012},
    ARoof=56.82,
    alphaRoof=2.6999999999999997,
    nRoof=1,
    RRoof={0.00561404014098},
    RRoofRem=0.0509181679224,
    CRoof={6671542.52055},
  ...
  *115.12)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=930.0000000000002)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1420.5)
