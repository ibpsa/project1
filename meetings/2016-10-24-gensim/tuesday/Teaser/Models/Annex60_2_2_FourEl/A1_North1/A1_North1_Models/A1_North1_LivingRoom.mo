within Annex60_2_2_FourEl.A1_North1.A1_North1_Models;
model A1_North1_LivingRoom
  "This is the simulation model of A1_North1_LivingRoom"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.000753402445744},
    CExt={19516536.738},
    alphaRad=2.8784313036758635,
    AInt=241.6,
    ...
    RExtRem=0.0220414813066,
    AFloor=72.86,
    alphaFloor=2.7000000000000006,
    nFloor=1,
    RFloor={0.000565145528901},
    RFloorRem=0.0312117705628,
    CFloor={6640844.12692},
    ARoof=72.86,
    alphaRoof=2.7000000000000006,
    nRoof=1,
    RRoof={0.00437811914371},
    RRoofRem=0.0397086234058,
    CRoof={8554885.39329},
  ...
  *102.32)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1821.4999999999998)
