...
model A1_North1_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of A1_North1_WCandsanitaryroomsinnonresidentialbuildings"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00328874309934},
    CExt={4470950.1675},
    alphaRad=2.9442344045368625,
    AInt=34.8,
    ...
    RExtRem=0.0962152033829,
    AFloor=10.5,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.00392157173674},
    RFloorRem=0.21657996221,
    CFloor={957025.299652},
    ARoof=10.5,
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.03037997722},
    RRoofRem=0.2755400287,
    CRoof={1232861.60623},
  ...
  *23.44)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=135.0)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=262.49999999999994)
