...
model T1_East1_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of T1_East1_WCandsanitaryroomsinnonresidentialbuildings"
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={0.00325350273226},
    CInt={3003819.3732},
    RWin=0.480263157895,
    RExtRem=0.450696316406,
    AFloor=0.0,
    alphaFloor=0.001,
    nFloor=1,
    RFloor={1e-05},
...
equation
  ...
  StopTime=31536000,
  Interval=3600));
end T1_East1_WCandsanitaryroomsinnonresidentialbuildings;
