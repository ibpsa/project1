...
model T1_East1_BedRoom
  "This is the simulation model of T1_East1_BedRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=2, UWin=1.6922685420811547)
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={0.000646276031545},
    CInt={16281750.687},
    RWin=0.0594139989148,
    RExtRem=0.0835228637617,
    AFloor=0.0,
    alphaFloor=0.001,
    nFloor=1,
    RFloor={1e-05},
    ...
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.0199368600506},
    RRoofRem=0.180823143834,
    CRoof={1878646.25711},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.32160580697726093, 0.678394193022739},
    wfWin={0.3711340206185567, 0.6288659793814434},
    withLongwave=true,
