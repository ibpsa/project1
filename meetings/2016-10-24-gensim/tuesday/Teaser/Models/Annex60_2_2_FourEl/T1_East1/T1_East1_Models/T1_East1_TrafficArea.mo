within Annex60_2_2_FourEl.T1_East1.T1_East1_Models;
model T1_East1_TrafficArea
  "This is the simulation model of T1_East1_TrafficArea"
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.24760574620909823, 0.7523942537909016},
    wfWin={0.3246753246753246, 0.6753246753246753},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
