...
model T1_East1_LivingRoom
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=3, UWin=1.692268542081155)
  ...
  thermalZoneFourElements(
    ...
    nRoof=1,
    RRoof={0.0354433067567},
    RRoofRem=0.321463366817,
    CRoof={1056738.51962},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.0, 0.7056029153380621, 0.29439708466193787},
    wfWin={0.1744452945677123, 0.605202754399388, 0.22035195103289976},
    withLongwave=true,
    aExt=0.7,
