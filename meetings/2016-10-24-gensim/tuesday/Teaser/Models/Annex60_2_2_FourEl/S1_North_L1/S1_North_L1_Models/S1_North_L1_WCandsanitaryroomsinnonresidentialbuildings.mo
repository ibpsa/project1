...
model S1_North_L1_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of S1_North_L1_WCandsanitaryroomsinnonresidentialbuildings"
  ...
  thermalZoneFourElements(
    ...
    nRoof=1,
    RRoof={0.0506332953667},
    RRoofRem=0.459233381167,
    CRoof={739716.963735},
  ...
  *10.144)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=157.5)
