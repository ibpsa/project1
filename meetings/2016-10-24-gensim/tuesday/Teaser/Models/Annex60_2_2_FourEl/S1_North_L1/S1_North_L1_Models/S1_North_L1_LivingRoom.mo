...
model S1_North_L1_LivingRoom
  "This is the simulation model of S1_North_L1_LivingRoom"
  ...
  thermalZoneFourElements(
    ...
    nOrientations=3,
    AWin={8.71, 2.22, 6.6},
    ATransparent={8.71, 2.22, 6.6},
    AExt={14.502, 10.212, 25.04}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.29147405233750046, 0.20524982915946452, 0.5032761185030349},
    wfWin={0.4968625213918996, 0.1266400456360525, 0.37649743297204785},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
