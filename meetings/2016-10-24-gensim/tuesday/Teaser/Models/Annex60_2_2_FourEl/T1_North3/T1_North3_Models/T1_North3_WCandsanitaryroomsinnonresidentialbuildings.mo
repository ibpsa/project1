...
model T1_North3_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of T1_North3_WCandsanitaryroomsinnonresidentialbuildings"
...
equation
  ...
  StopTime=31536000,
  Interval=3600));
end T1_North3_WCandsanitaryroomsinnonresidentialbuildings;
