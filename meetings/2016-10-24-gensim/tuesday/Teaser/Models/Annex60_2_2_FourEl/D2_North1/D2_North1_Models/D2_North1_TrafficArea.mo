...
model D2_North1_TrafficArea
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.000934547039054},
    CExt={7751350.94515},
    alphaRad=3.579573176240987,
    AInt=31.442,
    ...
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.00034592037665},
    RRoofRem=0.0161254669557,
    CRoof={434778.668717},
    ...
    nOrientations=3,
    AWin={0.0, 1.24, 0.0},
    ATransparent={0.0, 1.24, 0.0},
    AExt={38.912, 0.0, 7.784}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.833304779852664, 0.0, 0.16669522014733598},
    wfWin={0.0, 1.0, 0.0},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
  ...
  *46.696)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=377.49999999999994)
