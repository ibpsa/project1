within Annex60_2_2_FourEl.D2_North1.D2_North1_Models;
model D2_North1_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of D2_North1_WCandsanitaryroomsinnonresidentialbuildings"
  ...
  thermalZoneFourElements(
    ...
    nRoof=1,
    RRoof={0.000870566281237},
    RRoofRem=0.0405824251718,
    CRoof={172759.735914},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.5205670462468046, 0.4794329537531954},
    wfWin={0.0, 1.0},
    withLongwave=true,
    aExt=0.7,
...
equation
  ...
  StopTime=31536000,
  Interval=3600));
end D2_North1_WCandsanitaryroomsinnonresidentialbuildings;
