...
model T1_North2_LivingRoom
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi={3.141592653589793, -1.5707963267948966, 0.0})
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=3, UWin=1.6922685420811552)
  ...
  thermalZoneFourElements(
    ...
    nOrientations=3,
    AWin={7.91, 2.28, 2.88},
    ATransparent={7.91, 2.28, 2.88},
    AExt={21.686, 0.0, 9.048}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.7056029153380621, 0.0, 0.29439708466193787},
    wfWin={0.605202754399388, 0.1744452945677123, 0.22035195103289976},
    withLongwave=true,
    aExt=0.7,
