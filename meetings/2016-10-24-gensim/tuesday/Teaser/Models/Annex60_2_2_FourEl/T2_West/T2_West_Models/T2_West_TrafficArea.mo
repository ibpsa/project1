within Annex60_2_2_FourEl.T2_West.T2_West_Models;
model T2_West_TrafficArea
  "This is the simulation model of T2_West_TrafficArea"
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.7523942537909019, 0.24760574620909817},
    wfWin={0.6753246753246753, 0.32467532467532473},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
