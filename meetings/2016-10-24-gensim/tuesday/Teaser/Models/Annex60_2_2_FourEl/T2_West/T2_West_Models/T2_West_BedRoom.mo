...
model T2_West_BedRoom
  "This is the simulation model of T2_West_BedRoom"
  ...
  thermalZoneFourElements(
    ...
    nOrientations=2,
    AWin={4.88, 2.88},
    ATransparent={4.88, 2.88},
    AExt={18.318, 8.684}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.6783941930227391, 0.321605806977261},
    wfWin={0.6288659793814433, 0.3711340206185567},
    withLongwave=true,
