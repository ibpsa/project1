...
model T2_West_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of T2_West_WCandsanitaryroomsinnonresidentialbuildings"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00872094495117},
    CExt={830644.169298},
    alphaRad=1.089792785878741,
    AInt=21.398999999999997,
    alphaInt=10.246614327772328,
    nInt=1,
    RInt={0.00377905030141},
    CInt={3473696.16928},
    RWin=0.0729166666667,
    RExtRem=0.0991927241136,
    AFloor=0.0,
    alphaFloor=0.001,
    nFloor=1,
    RFloor={1e-05},
...
equation
  ...
  StopTime=31536000,
  Interval=3600));
end T2_West_WCandsanitaryroomsinnonresidentialbuildings;
