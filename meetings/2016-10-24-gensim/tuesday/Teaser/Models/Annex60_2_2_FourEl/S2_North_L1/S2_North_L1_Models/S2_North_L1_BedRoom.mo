within Annex60_2_2_FourEl.S2_North_L1.S2_North_L1_Models;
model S2_North_L1_BedRoom
  ...
  thermalZoneFourElements(
    ...
    nOrientations=3,
    AWin={2.0, 5.76, 0.0},
    ATransparent={2.0, 5.76, 0.0},
    AExt={21.212, 25.88, 12.068}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.3585530764029749, 0.4374577417173766, 0.2039891818796484},
    wfWin={0.2577319587628866, 0.7422680412371134, 0.0},
    withLongwave=true,
