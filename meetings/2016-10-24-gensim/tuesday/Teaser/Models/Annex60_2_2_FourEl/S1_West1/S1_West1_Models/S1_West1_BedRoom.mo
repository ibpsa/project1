...
model S1_West1_BedRoom
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi={-1.5707963267948966, 0.0, 1.5707963267948966})
  ...
  thermalZoneFourElements(
    ...
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.00748802255423},
    RRoofRem=0.0679147958063,
    CRoof={5001895.65954},
    ...
    nOrientations=3,
    AWin={0.0, 5.76, 2.0},
    ATransparent={0.0, 5.76, 2.0},
    AExt={12.068, 25.88, 21.212}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.2039891818796484, 0.43745774171737667, 0.358553076402975},
    wfWin={0.0, 0.7422680412371134, 0.25773195876288657},
    withLongwave=true,
