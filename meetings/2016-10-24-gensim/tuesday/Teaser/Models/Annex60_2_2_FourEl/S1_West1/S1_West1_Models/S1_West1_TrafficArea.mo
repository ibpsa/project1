within Annex60_2_2_FourEl.S1_West1.S1_West1_Models;
model S1_West1_TrafficArea
  "This is the simulation model of S1_West1_TrafficArea"
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=1, UWin=1.6922685420811547)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00760238049788},
    CExt={1934105.57587},
    alphaRad=2.231037996797205,
    AInt=45.648,
    alphaInt=11.167731335436383,
    nInt=1,
    RInt={0.0015323382696},
    CInt={6532466.95405},
    RWin=0.720394736842,
    RExtRem=0.222414631883,
    AFloor=18.3,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.00225008214403},
    RFloorRem=0.124267191432,
    CFloor={1667958.37939},
    ARoof=7.7,
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.0414272416637},
    RRoofRem=0.375736402773,
    CRoof={904098.511232},
