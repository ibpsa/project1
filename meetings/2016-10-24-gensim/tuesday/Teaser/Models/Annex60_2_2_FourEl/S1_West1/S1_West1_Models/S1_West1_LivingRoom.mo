...
model S1_West1_LivingRoom
  "This is the simulation model of S1_West1_LivingRoom"
  ...
  thermalZoneFourElements(
    ...
    nOrientations=3,
    AWin={2.22, 6.6, 8.71},
    ATransparent={2.22, 6.6, 8.71},
    AExt={10.212, 25.04, 14.502}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.20524982915946452, 0.5032761185030349, 0.29147405233750046},
    wfWin={0.1266400456360525, 0.37649743297204785, 0.4968625213918996},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
