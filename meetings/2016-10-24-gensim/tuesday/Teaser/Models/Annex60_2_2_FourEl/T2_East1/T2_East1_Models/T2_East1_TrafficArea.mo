within Annex60_2_2_FourEl.T2_East1.T2_East1_Models;
model T2_East1_TrafficArea
  "This is the simulation model of T2_East1_TrafficArea"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966},
    each lat = 0.8861990609344351,
    azi={-1.5707963267948966, 1.5707963267948966})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  Annex60.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[2](
    til={1.5707963267948966, 1.5707963267948966},
    each lat = 0.8861990609344351,
    azi={-1.5707963267948966, 1.5707963267948966})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=2, UWin=5.003248862897985)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00217675621188},
    CExt={3327888.55038},
    alphaRad=2.1599120990576006,
    AInt=53.764,
    alphaInt=10.20342236440741,
    nInt=1,
    RInt={0.0015049648786},
    CInt={8700181.84556},
    RWin=0.0227272727273,
    RExtRem=0.0247585989358,
    AFloor=8.63,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.00366563535111},
    RFloorRem=0.0158253591927,
    CFloor={1273846.45257},
    ARoof=9.13,
    alphaRoof=2.6999999999999997,
    nRoof=1,
    RRoof={0.000572113656891},
    RRoofRem=0.0266697208139,
    CRoof={262882.731482},
    ...
    nOrientations=2,
    AWin={1.0, 2.08},
    ATransparent={1.0, 2.08},
    AExt={4.964, 15.084}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.24760574620909817, 0.7523942537909019},
    wfWin={0.32467532467532473, 0.6753246753246753},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
  ...
  *20.048000000000002)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=77.0)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=228.25000000000003)
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTilRoof[2](
    til={0.7853981633974483, 0.7853981633974483},
    each lat = 0.8861990609344351,
    azi={-1.5707963267948966, 1.5707963267948966})
    "Calculates direct solar radiation on titled surface for both directions"
    annotation (Placement(transformation(extent={{-68,74},{-48,94}})));
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTilRoof[2](
    til={0.7853981633974483, 0.7853981633974483},
    each lat = 0.8861990609344351,
    azi={-1.5707963267948966, 1.5707963267948966})
