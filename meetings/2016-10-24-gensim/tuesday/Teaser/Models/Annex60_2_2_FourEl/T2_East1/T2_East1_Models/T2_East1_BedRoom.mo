...
model T2_East1_BedRoom
  "This is the simulation model of T2_East1_BedRoom"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00161616208191},
    CExt={4482224.99188},
    alphaRad=1.5877116709099897,
    AInt=109.097,
    alphaInt=10.237191673464899,
    nInt=1,
    RInt={0.000788307168172},
    CInt={17952305.9614},
    RWin=0.0090206185567,
    RExtRem=0.0183823565463,
    AFloor=0.0,
    alphaFloor=0.001,
    nFloor=1,
    RFloor={1e-05},
    ...
    alphaRoof=2.7,
    nRoof=1,
    RRoof={0.000326462355464},
    RRoofRem=0.0152184094394,
    CRoof={460692.629104},
    ...
    nOrientations=2,
    AWin={2.88, 4.88},
    ATransparent={2.88, 4.88},
    AExt={8.684, 18.318}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.321605806977261, 0.6783941930227391},
    wfWin={0.3711340206185567, 0.6288659793814433},
    withLongwave=true,
  ...
  *27.002000000000002)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=400.0)
