...
model T2_East1_LivingRoom
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    ...
    azi={3.141592653589793, -1.5707963267948966, 1.5707963267948966})
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=3, UWin=5.003248862897985)
  ...
  thermalZoneFourElements(
    ...
    ARoof=9.0,
    alphaRoof=2.7000000000000006,
    nRoof=1,
    RRoof={0.000580377520824},
    RRoofRem=0.0270549501145,
    CRoof={259139.603871},
    ...
    nOrientations=3,
    AWin={2.28, 7.91, 2.88},
    ATransparent={2.28, 7.91, 2.88},
    AExt={0.0, 21.686, 9.048}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.0, 0.7056029153380621, 0.294397084661938},
    wfWin={0.1744452945677123, 0.6052027543993881, 0.22035195103289978},
    withLongwave=true,
    aExt=0.7,
  ...
  *30.734)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=225.0)
