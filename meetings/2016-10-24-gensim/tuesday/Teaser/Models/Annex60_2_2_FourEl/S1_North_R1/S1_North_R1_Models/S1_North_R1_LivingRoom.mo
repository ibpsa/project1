...
model S1_North_R1_LivingRoom
  "This is the simulation model of S1_North_R1_LivingRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.29147405233750046, 0.5032761185030349, 0.20524982915946452},
