...
model D1_North3_LivingRoom
  "This is the simulation model of D1_North3_LivingRoom"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.0012125733515},
    CExt={12126117.148},
    alphaRad=3.2721544993836456,
    AInt=70.644,
    alphaInt=14.299782005548948,
    nInt=1,
    RInt={0.000997226154544},
    CInt={11901545.2468},
    RWin=0.0282680951305,
    RExtRem=0.035474948364,
    AFloor=53.9,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.000763942546118},
    RFloorRem=0.0421909017293,
    CFloor={4912729.87155},
    ARoof=0.0,
    alphaRoof=0.001,
    nRoof=1,
    RRoof={1e-05},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.13741466637304556, 0.2755214395822191, 0.42747034951395224, 0.15959354453078303},
    wfWin={0.0, 0.29429797670141017, 0.43163703249540164, 0.27406499080318825},
    withLongwave=true,
