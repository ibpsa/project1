...
model D2_North2_LivingRoom
  "This is the simulation model of D2_North2_LivingRoom"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.000686437986216},
    CExt={10553032.0581},
    alphaRad=3.2721544993836456,
    AInt=70.644,
    alphaInt=14.299782005548948,
    nInt=1,
    RInt={0.00108130161096},
    CInt={14988202.1063},
    RWin=0.00429184549356,
    RExtRem=0.00780760045717,
    AFloor=53.9,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.00058690970464},
    RFloorRem=0.00253381910637,
    CFloor={7956005.07454},
    ARoof=0.0,
    alphaRoof=0.001,
    nRoof=1,
    RRoof={1e-05},
    ...
    nOrientations=4,
    AWin={0.0, 4.8, 7.04, 4.47},
    ATransparent={0.0, 4.8, 7.04, 4.47},
    AExt={8.736, 17.516, 27.176, 10.146}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.13741466637304559, 0.2755214395822191, 0.4274703495139523, 0.15959354453078303},
    wfWin={0.0, 0.29429797670141017, 0.43163703249540164, 0.2740649908031882},
    withLongwave=true,
  ...
  *63.574)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=407.7499999999999)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=0.001)
