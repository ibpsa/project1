within Annex60_2_2_FourEl.D2_North2.D2_North2_Models;
model D2_North2_BedRoom
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4, UWin=5.003248862897986)
  ...
  thermalZoneFourElements(
    ...
    nRoof=1,
    RRoof={0.000107036837857},
    RRoofRem=0.00498964243915,
    CRoof={1405112.51877},
    ...
    nOrientations=4,
    AWin={0.0, 1.68, 4.32, 2.7},
    ATransparent={0.0, 1.68, 4.32, 2.7},
    AExt={9.66, 11.648, 30.372, 19.0}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.1366723259762309, 0.16479909451046973, 0.4297113752122241, 0.2688172043010753},
    wfWin={0.0, 0.19310344827586204, 0.4965517241379311, 0.3103448275862069},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
  ...
  *70.67999999999999)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=1220.0)
