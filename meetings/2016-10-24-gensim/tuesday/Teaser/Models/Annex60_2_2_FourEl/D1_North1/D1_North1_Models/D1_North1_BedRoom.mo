...
model D1_North1_BedRoom
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4, UWin=1.692268542081155)
  ...
  thermalZoneFourElements(
    ...
    nRoof=1,
    RRoof={0.00653667542644},
    RRoofRem=0.059286276667,
    CRoof={5729871.08417},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.13667232597623089, 0.16479909451046976, 0.4297113752122242, 0.26881720430107525},
    wfWin={0.0, 0.19310344827586207, 0.4965517241379311, 0.3103448275862069},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
