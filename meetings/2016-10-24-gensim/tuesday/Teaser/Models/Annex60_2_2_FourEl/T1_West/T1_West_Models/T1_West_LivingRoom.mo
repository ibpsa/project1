...
model T1_West_LivingRoom
  ...
  thermalZoneFourElements(
    ...
    nOrientations=3,
    AWin={2.28, 2.88, 7.91},
    ATransparent={2.28, 2.88, 7.91},
    AExt={0.0, 9.048, 21.686}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.0, 0.29439708466193787, 0.7056029153380621},
    wfWin={0.1744452945677123, 0.22035195103289976, 0.605202754399388},
    withLongwave=true,
    aExt=0.7,
