...
model T1_West_BedRoom
  "This is the simulation model of T1_West_BedRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.678394193022739, 0.32160580697726093},
    wfWin={0.6288659793814434, 0.3711340206185567},
    withLongwave=true,
