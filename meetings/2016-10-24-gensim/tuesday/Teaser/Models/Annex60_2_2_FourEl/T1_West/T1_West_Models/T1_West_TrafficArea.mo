within Annex60_2_2_FourEl.T1_West.T1_West_Models;
model T1_West_TrafficArea
  "This is the simulation model of T1_West_TrafficArea"
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=2, UWin=1.692268542081155)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00384517848406},
    CExt={3823959.42654},
    alphaRad=2.1599120990576006,
    AInt=53.764,
    alphaInt=10.20342236440741,
    nInt=1,
    RInt={0.00129436622128},
    CInt={7534814.96351},
    RWin=0.14969241285,
    RExtRem=0.112494232207,
    AFloor=8.63,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.00477132134829},
    RFloorRem=0.263509803384,
    CFloor={786583.651047},
    ARoof=9.13,
    alphaRoof=2.6999999999999997,
    nRoof=1,
    RRoof={0.0349386375477},
    RRoofRem=0.31688612282,
    CRoof={1072002.52046},
    ...
    nOrientations=2,
    AWin={2.08, 1.0},
    ATransparent={2.08, 1.0},
    AExt={15.084, 4.964}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.0,
    wfWall={0.7523942537909016, 0.24760574620909823},
    wfWin={0.6753246753246753, 0.3246753246753246},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
