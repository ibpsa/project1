within Annex60_2_2_FourEl.D1_North4.D1_North4_Models;
model D1_North4_WCandsanitaryroomsinnonresidentialbuildings
  "This is the simulation model of D1_North4_WCandsanitaryroomsinnonresidentialbuildings"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[2](
    ...
    azi={3.141592653589793, -1.5707963267948966})
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00447874379785},
    CExt={3283020.23392},
    alphaRad=3.08773184814266,
    AInt=14.97,
    alphaInt=7.699999999999999,
    nInt=1,
    RInt={0.00419451346571},
    CInt={1768151.92898},
    RWin=0.480263157895,
    RExtRem=0.131029768028,
    AFloor=0.0,
    alphaFloor=0.001,
    nFloor=1,
    RFloor={1e-05},
    ...
    nRoof=1,
    RRoof={0.0531649601351},
    RRoofRem=0.482195050225,
    CRoof={704492.346415},
  ...
  *17.212000000000003)
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant alphaRoof(k=150.0)
...
equation
  ...
  StopTime=31536000,
  Interval=3600));
end D1_North4_WCandsanitaryroomsinnonresidentialbuildings;
