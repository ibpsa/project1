within Annex60_2_2_Offices.S1_East1.S1_East1_Models;
model S1_East1_BedRoom
  "This is the simulation model of S1_East1_BedRoom"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[5](
    ...
    azi={-1.5707963267948966, -1.5707963267948966, 0.0, 1.5707963267948966, 1.5707963267948966})
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5, UWin=1.6922685420811547)
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00129544598604},
    CExt={15974968.3734},
    alphaRad=3.030403647995041,
    AInt=71.182,
    alphaInt=7.699999999999999,
    nInt=1,
    RInt={0.000949501663025},
    CInt={9265521.75169},
    RWin=0.0594139989148,
    RExtRem=0.0246217213822,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={2.0, 0.0, 5.76, 0.0, 0.0},
    ATransparent={2.0, 0.0, 5.76, 0.0, 0.0},
    AExt={21.212, 21.3, 25.88, 12.068, 21.3}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.23426876695613386, 0.17331368439739586, 0.28582291574697083, 0.13328094850210367, 0.17331368439739586},
    wfWin={0.25773195876288657, 0.0, 0.7422680412371134, 0.0, 0.0},
    withLongwave=true,
