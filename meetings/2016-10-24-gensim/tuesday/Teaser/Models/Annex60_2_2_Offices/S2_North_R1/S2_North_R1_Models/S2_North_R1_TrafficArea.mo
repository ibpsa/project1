...
model S2_North_R1_TrafficArea
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00117029319146},
    CExt={4603318.76127},
    alphaRad=2.231037996797204,
    AInt=45.648,
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.6337751998695583,
    wfWall={0.10498010780689343, 0.1562645845166548, 0.10498010780689343},
    wfWin={0.0, 1.0, 0.0},
    withLongwave=true,
