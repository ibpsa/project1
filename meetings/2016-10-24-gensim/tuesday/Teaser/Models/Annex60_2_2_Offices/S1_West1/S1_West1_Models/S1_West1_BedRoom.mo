within Annex60_2_2_Offices.S1_West1.S1_West1_Models;
model S1_West1_BedRoom
  "This is the simulation model of S1_West1_BedRoom"
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=5,
    AWin={0.0, 0.0, 5.76, 2.0, 0.0},
    ATransparent={0.0, 0.0, 5.76, 2.0, 0.0},
    AExt={12.068, 21.3, 25.88, 21.212, 21.3}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.13328094850210367, 0.17331368439739586, 0.28582291574697083, 0.23426876695613386, 0.17331368439739586},
    wfWin={0.0, 0.0, 0.7422680412371134, 0.25773195876288657, 0.0},
    withLongwave=true,
