within Annex60_2_2_Offices.T2_East1.T2_East1_Models;
model T2_East1_LivingRoom
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.6774182658725408,
    wfWall={0.0, 0.14992992451245696, 0.05504844568666941, 0.06255491824166332, 0.05504844568666941},
    wfWin={0.1744452945677123, 0.6052027543993881, 0.0, 0.22035195103289978, 0.0},
    withLongwave=true,
    aExt=0.7,
