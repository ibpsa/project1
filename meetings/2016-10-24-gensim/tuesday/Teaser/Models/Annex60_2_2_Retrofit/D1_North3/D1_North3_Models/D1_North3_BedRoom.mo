within Annex60_2_2_Retrofit.D1_North3.D1_North3_Models;
model D1_North3_BedRoom
  "This is the simulation model of D1_North3_BedRoom"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[6](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.7853981633974483, 1.5707963267948966, 1.5707963267948966, 0.7853981633974483, 1.5707963267948966},
    each lat = 0.8861990609344351,
    azi={3.141592653589793, 3.141592653589793, -1.5707963267948966, 0.0, 0.0, 1.5707963267948966})
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6, UWin=0.7299962078119074)
  ...
  thermalZoneTwoElements(
    ...
    VAir=273.28,
    alphaExt=7.6999999999999975,
    alphaWin=2.7,
    gWin=0.5999999999999999,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0018086693044},
    CExt={20934902.2545},
    alphaRad=3.2126279487102374,
    AInt=71.314,
    alphaInt=7.700000000000001,
    nInt=1,
    RInt={0.000965435205416},
    CInt={9657979.00225},
    RWin=0.142528735632,
    RExtRem=0.0345250376314,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={0.0, 0.0, 1.68, 4.32, 0.0, 2.7},
    ATransparent={0.0, 0.0, 1.68, 4.32, 0.0, 2.7},
    AExt={9.66, 24.4, 11.648, 30.372, 24.4, 19.0}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.0,
    wfWall={0.08675607711651301, 0.1826128607352413, 0.10461022632020119, 0.27276972817626627, 0.1826128607352413, 0.17063824691653698},
    wfWin={0.0, 0.0, 0.19310344827586204, 0.4965517241379311, 0.0, 0.31034482758620685},
    withLongwave=true,
    aExt=0.7,
  ...
  *119.48)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=217.49999999999994)
