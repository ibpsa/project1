...
model T2_West_BedRoom
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=4,
    AWin={4.88, 0.0, 2.88, 0.0},
    ATransparent={4.88, 0.0, 2.88, 0.0},
    AExt={18.318, 8.0, 8.684, 8.0}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.45414276978001095, 0.16528106044328383, 0.21529510933342147, 0.16528106044328383},
    wfWin={0.6288659793814433, 0.0, 0.37113402061855677, 0.0},
    withLongwave=true,
    aExt=0.7,
