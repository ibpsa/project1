within Annex60_2_2_Retrofit.S2_East1.S2_East1_Models;
model S2_East1_BedRoom
  "This is the simulation model of S2_East1_BedRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5, UWin=0.7299962078119075)
  ...
  thermalZoneTwoElements(
    ...
    VAir=238.56,
    alphaExt=7.700000000000002,
    alphaWin=2.6999999999999997,
    gWin=0.6,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00222137268909},
    CExt={19406022.9009},
    alphaRad=3.030403647995041,
    AInt=71.182,
    alphaInt=7.699999999999999,
    nInt=1,
    RInt={0.0011769627644},
    CInt={9486469.26195},
    RWin=0.159793814433,
    RExtRem=0.0405195721359,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={5.76, 2.0, 0.0, 0.0, 0.0},
    ATransparent={5.76, 2.0, 0.0, 0.0, 0.0},
    AExt={25.88, 21.212, 21.3, 12.068, 21.3}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.2733995351785337, 0.22408620325375025, 0.18751320515529268, 0.12748785125713077, 0.18751320515529268},
    wfWin={0.7422680412371134, 0.25773195876288657, 0.0, 0.0, 0.0},
    withLongwave=true,
  ...
  Annex60.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004
  *101.75999999999999)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=194.0)
