...
model S2_East1_LivingRoom
  "This is the simulation model of S2_East1_LivingRoom"
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=3,
    AWin={6.6, 8.71, 2.22},
    ATransparent={6.6, 8.71, 2.22},
    AExt={25.04, 14.502, 10.212}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.5942721542212691,
    wfWall={0.2041931353921177, 0.11825913935529117, 0.08327557103132213},
    wfWin={0.3764974329720479, 0.4968625213918996, 0.1266400456360525},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
