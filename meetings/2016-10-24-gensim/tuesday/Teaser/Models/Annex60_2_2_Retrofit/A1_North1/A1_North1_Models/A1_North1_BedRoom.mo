...
model A1_North1_BedRoom
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=2, UWin=0.7299962078119075)
  ...
  thermalZoneTwoElements(
    ...
    CInt={48013682.3645},
    RWin=0.0333333333333,
    RExtRem=0.0163128274389,
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.30418210240047977,
    wfWall={0.49302982933253386, 0.20278806826698648},
    wfWin={1.0, 0.0},
    withLongwave=true,
