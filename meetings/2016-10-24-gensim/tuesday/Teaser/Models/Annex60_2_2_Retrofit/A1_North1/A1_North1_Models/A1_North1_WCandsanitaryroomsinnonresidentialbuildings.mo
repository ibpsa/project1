within Annex60_2_2_Retrofit.A1_North1.A1_North1_Models;
model A1_North1_WCandsanitaryroomsinnonresidentialbuildings
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=2, UWin=0.7299962078119074)
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=2,
    wfGro=0.28963919232042373,
    wfWall={0.5172680127992938, 0.19309279488028247},
    wfWin={1.0, 0.0},
    withLongwave=true,
