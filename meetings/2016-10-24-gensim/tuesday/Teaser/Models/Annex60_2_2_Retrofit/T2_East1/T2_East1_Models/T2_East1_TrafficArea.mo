...
model T2_East1_TrafficArea
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4, UWin=0.7299962078119074)
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.28060417145359245,
    wfWall={0.12912343982346539, 0.09895388510511006, 0.3923646185127221, 0.09895388510511006},
    wfWin={0.3246753246753246, 0.0, 0.6753246753246754, 0.0},
    withLongwave=true,
