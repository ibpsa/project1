...
model T2_East1_BedRoom
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00504113801887},
    CExt={8759664.78615},
    alphaRad=1.5877116709099892,
    AInt=109.097,
    ...
    CInt={17952305.9614},
    RWin=0.159793814433,
    RExtRem=0.0952394296493,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=4,
    AWin={2.88, 0.0, 4.88, 0.0},
    ATransparent={2.88, 0.0, 4.88, 0.0},
    AExt={8.684, 8.0, 18.318, 8.0}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.21529510933342147, 0.16528106044328383, 0.45414276978001095, 0.16528106044328383},
    wfWin={0.37113402061855677, 0.0, 0.6288659793814433, 0.0},
    withLongwave=true,
    aExt=0.7,
