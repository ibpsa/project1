within Annex60_2_2_Retrofit.T2_East1.T2_East1_Models;
model T2_East1_LivingRoom
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5, UWin=0.7299962078119077)
  ...
  thermalZoneTwoElements(
    ...
    CInt={16314153.2288},
    RWin=0.0948737566947,
    RExtRem=0.0419487957097,
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.5877024608018634,
    wfWall={0.0, 0.23385166174218733, 0.04043824271572454, 0.09756939202450018, 0.04043824271572454},
    wfWin={0.1744452945677123, 0.6052027543993879, 0.0, 0.22035195103289978, 0.0},
    withLongwave=true,
    aExt=0.7,
  ...
  *83.334)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=326.75000000000006)
