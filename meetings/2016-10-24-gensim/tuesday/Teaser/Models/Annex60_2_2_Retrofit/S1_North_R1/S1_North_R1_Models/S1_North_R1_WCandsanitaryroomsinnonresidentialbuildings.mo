...
model S1_North_R1_WCandsanitaryroomsinnonresidentialbuildings
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=3, UWin=0.7299962078119074)
  ...
  thermalZoneTwoElements(
    ...
    CInt={2515159.70498},
    RWin=1.24,
    RExtRem=0.241902045466,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=3,
    AWin={0.0, 1.0, 0.0},
    ATransparent={0.0, 1.0, 0.0},
    AExt={3.45, 10.144, 3.45}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.18088586888133887, 0.6382282622373222, 0.18088586888133887},
    wfWin={0.0, 1.0, 0.0},
    withLongwave=true,
    aExt=0.7,
