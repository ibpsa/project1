within Annex60_2_2_Retrofit.D2_North2.D2_North2_Models;
model D2_North2_BedRoom
  "This is the simulation model of D2_North2_BedRoom"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00187451042864},
    CExt={23124758.6969},
    alphaRad=3.2126279487102374,
    AInt=71.314,
    alphaInt=7.700000000000001,
    nInt=1,
    RInt={0.00124180205645},
    CInt={9596728.56117},
    RWin=0.142528735632,
    RExtRem=0.0344591965072,
