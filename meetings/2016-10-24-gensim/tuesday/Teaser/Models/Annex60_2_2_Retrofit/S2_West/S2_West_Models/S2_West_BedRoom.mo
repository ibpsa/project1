within Annex60_2_2_Retrofit.S2_West.S2_West_Models;
model S2_West_BedRoom
  "This is the simulation model of S2_West_BedRoom"
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=5,
    AWin={5.76, 0.0, 0.0, 2.0, 0.0},
    ATransparent={5.76, 0.0, 0.0, 2.0, 0.0},
    AExt={25.88, 12.068, 21.3, 21.212, 21.3}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.2733995351785337, 0.12748785125713077, 0.18751320515529268, 0.22408620325375025, 0.18751320515529268},
    wfWin={0.7422680412371134, 0.0, 0.0, 0.25773195876288657, 0.0},
    withLongwave=true,
