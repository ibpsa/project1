...
model S2_West_LivingRoom
  "This is the simulation model of S2_West_LivingRoom"
  ...
  thermalZoneTwoElements(
    ...
    nOrientations=3,
    AWin={6.6, 2.22, 8.71},
    ATransparent={6.6, 2.22, 8.71},
    AExt={25.04, 10.212, 14.502}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.594272154221269,
    wfWall={0.20419313539211767, 0.08327557103132212, 0.11825913935529116},
    wfWin={0.3764974329720479, 0.1266400456360525, 0.4968625213918996},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
    alphaRad=5.0,
