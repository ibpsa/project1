within Annex60_2_2_AixLib.S2_North_R1;
model S2_North_R1
  "This is the simulation model of S2_North_R1"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.S2_North_R1.S2_North_R1_DataBase.S2_North_R1_base()
  ...
  AixLib.Building.Components.Weather.Weather weather(
    ...
    (nSurfaces=5,
    name={"0.0", "0", "180.0", "180", "270.0"},
    Azimut={180.0, 180.0, 0.0, 0.0, 90.0},
    Tilt={90.0, 45.0, 90.0, 45.0, 90.0}))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S2_North_R1//TSetS2_North_R1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S2_North_R1//AHU_S2_North_R1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:13,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S2_North_R1//InternalGains_S2_North_R1.mat"))
