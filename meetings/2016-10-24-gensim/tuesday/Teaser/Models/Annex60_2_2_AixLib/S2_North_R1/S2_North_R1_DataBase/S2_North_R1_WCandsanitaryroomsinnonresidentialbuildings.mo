...
record S2_North_R1_WCandsanitaryroomsinnonresidentialbuildings "S2_North_R1_WCandsanitaryroomsinnonresidentialbuildings"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    weightfactorswall = {0.0, 0.2730932437456271, 0.45381351250874585, 0.2730932437456271, 0.0},
