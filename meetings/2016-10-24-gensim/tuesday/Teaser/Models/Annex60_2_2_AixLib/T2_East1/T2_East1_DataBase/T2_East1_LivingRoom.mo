...
record T2_East1_LivingRoom "T2_East1_LivingRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    gsunblind = {1.0, 1.0, 0.0, 1.0, 0.0},
    Aw = {2.28, 7.91, 0.0, 2.88, 0.0},
    withWindows = true,
    weightfactorswindow = {0.17444529456771227, 0.6052027543993879, 0.0, 0.22035195103289973, 0.0},
    weightfactorswall = {0.0, 0.14992992451245696, 0.05504844568666941, 0.06255491824166332, 0.05504844568666941},
