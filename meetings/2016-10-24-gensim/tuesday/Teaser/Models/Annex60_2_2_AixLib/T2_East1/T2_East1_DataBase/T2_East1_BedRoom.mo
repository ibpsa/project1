...
record T2_East1_BedRoom "T2_East1_BedRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    withWindows = true,
    weightfactorswindow = {0.0, 0.3711340206185567, 0.0, 0.6288659793814433, 0.0},
    weightfactorswall = {0.0, 0.15699958771076253, 0.25591300855792215, 0.3311743951733933, 0.25591300855792215},
