within Annex60_2_2_AixLib.T2_East1;
model T2_East1
  "This is the simulation model of T2_East1"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.T2_East1.T2_East1_DataBase.T2_East1_base()
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T2_East1//TSetT2_East1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T2_East1//AHU_T2_East1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:13,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T2_East1//InternalGains_T2_East1.mat"))
