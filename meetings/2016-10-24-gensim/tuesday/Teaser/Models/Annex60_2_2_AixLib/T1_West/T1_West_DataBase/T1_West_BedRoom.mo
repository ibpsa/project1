...
record T1_West_BedRoom "T1_West_BedRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    withWindows = true,
    weightfactorswindow = {0.0, 0.6288659793814434, 0.0, 0.3711340206185567, 0.0},
    weightfactorswall = {0.0, 0.47223500190224055, 0.1519464591831996, 0.22387207973136028, 0.1519464591831996},
