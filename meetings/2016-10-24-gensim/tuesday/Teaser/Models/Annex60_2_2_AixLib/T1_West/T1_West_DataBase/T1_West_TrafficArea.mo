...
record T1_West_TrafficArea "T1_West_TrafficArea"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    withWindows = true,
    weightfactorswindow = {0.0, 0.6753246753246753, 0.0, 0.3246753246753246, 0.0},
    weightfactorswall = {0.0, 0.4253218307562465, 0.09483363791560355, 0.13996934287152007, 0.09483363791560355},
