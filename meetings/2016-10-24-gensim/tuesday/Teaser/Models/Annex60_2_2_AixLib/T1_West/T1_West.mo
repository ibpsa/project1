within Annex60_2_2_AixLib.T1_West;
model T1_West
  "This is the simulation model of T1_West"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.T1_West.T1_West_DataBase.T1_West_base()
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T1_West//TSetT1_West.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T1_West//AHU_T1_West.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:13,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T1_West//InternalGains_T1_West.mat"))
