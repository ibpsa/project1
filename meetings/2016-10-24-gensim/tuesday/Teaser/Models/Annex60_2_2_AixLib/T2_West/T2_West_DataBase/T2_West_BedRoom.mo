...
record T2_West_BedRoom "T2_West_BedRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    Aw = {0.0, 4.88, 0.0, 2.88, 0.0},
    withWindows = true,
    weightfactorswindow = {0.0, 0.6288659793814433, 0.0, 0.3711340206185567, 0.0},
    weightfactorswall = {0.0, 0.3311743951733933, 0.25591300855792215, 0.15699958771076253, 0.25591300855792215},
