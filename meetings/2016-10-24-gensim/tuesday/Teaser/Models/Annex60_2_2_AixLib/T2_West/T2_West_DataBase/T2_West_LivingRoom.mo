...
record T2_West_LivingRoom "T2_West_LivingRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    Aw = {2.28, 2.88, 0.0, 7.91, 0.0},
    withWindows = true,
    weightfactorswindow = {0.1744452945677123, 0.22035195103289978, 0.0, 0.6052027543993881, 0.0},
    weightfactorswall = {0.0, 0.06255491824166332, 0.05504844568666941, 0.14992992451245696, 0.05504844568666941},
