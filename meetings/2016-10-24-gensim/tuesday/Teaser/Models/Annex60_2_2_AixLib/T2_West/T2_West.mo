within Annex60_2_2_AixLib.T2_West;
model T2_West
  "This is the simulation model of T2_West"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.T2_West.T2_West_DataBase.T2_West_base()
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T2_West//TSetT2_West.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T2_West//AHU_T2_West.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:13,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/T2_West//InternalGains_T2_West.mat"))
