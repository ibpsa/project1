within Annex60_2_2_AixLib.A1_North1;
model A1_North1
  "This is the simulation model of A1_North1"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.A1_North1.A1_North1_DataBase.A1_North1_base()
  ...
  AixLib.Building.Components.Weather.Weather weather(
    ...
    (nSurfaces=4,
    name={"0.0", "180.0", "270.0", "-1.0"},
    Azimut={180.0, 0.0, 90.0, 0.0},
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:4,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/A1_North1//TSetA1_North1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/A1_North1//AHU_A1_North1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:10,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/A1_North1//InternalGains_A1_North1.mat"))
