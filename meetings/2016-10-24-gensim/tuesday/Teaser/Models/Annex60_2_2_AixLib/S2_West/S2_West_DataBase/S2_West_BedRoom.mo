...
record S2_West_BedRoom "S2_West_BedRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    Aw = {5.76, 0.0, 0.0, 2.0, 0.0},
    withWindows = true,
    weightfactorswindow = {0.7422680412371134, 0.0, 0.0, 0.2577319587628866, 0.0},
    weightfactorswall = {0.19236482159448498, 0.08970087585016401, 0.2801332525979573, 0.15766779735943642, 0.2801332525979573},
