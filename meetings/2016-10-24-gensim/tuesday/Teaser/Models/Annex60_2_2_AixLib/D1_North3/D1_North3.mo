within Annex60_2_2_AixLib.D1_North3;
model D1_North3
  "This is the simulation model of D1_North3"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.D1_North3.D1_North3_DataBase.D1_North3_base()
  ...
  AixLib.Building.Components.Weather.Weather weather(
    ...
    (nSurfaces=6,
    name={"0.0", "0", "90.0", "180.0", "180", "270.0"},
    Azimut={180.0, 180.0, -90.0, 0.0, 0.0, 90.0},
    Tilt={90.0, 45.0, 90.0, 90.0, 45.0, 90.0}))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/D1_North3//TSetD1_North3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/D1_North3//AHU_D1_North3.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:13,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/D1_North3//InternalGains_D1_North3.mat"))
