...
record S1_North_L1_BedRoom "S1_North_L1_BedRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    withWindows = true,
    weightfactorswindow = {0.25773195876288657, 0.0, 0.0, 0.0, 0.7422680412371134},
    weightfactorswall = {0.23426876695613386, 0.17331368439739586, 0.13328094850210367, 0.17331368439739586, 0.28582291574697083},
