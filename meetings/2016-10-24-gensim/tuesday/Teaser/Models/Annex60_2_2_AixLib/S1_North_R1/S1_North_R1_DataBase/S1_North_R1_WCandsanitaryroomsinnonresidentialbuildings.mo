...
record S1_North_R1_WCandsanitaryroomsinnonresidentialbuildings "S1_North_R1_WCandsanitaryroomsinnonresidentialbuildings"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    weightfactorswall = {0.0, 0.1669201301391879, 0.0, 0.6661597397216241, 0.1669201301391879},
