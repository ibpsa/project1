...
record S1_North_R1_LivingRoom "S1_North_R1_LivingRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    withWindows = true,
    weightfactorswindow = {0.4968625213918996, 0.0, 0.37649743297204785, 0.1266400456360525, 0.0},
    weightfactorswall = {0.13370597157694053, 0.0, 0.23086453787660946, 0.09415290178897506, 0.0},
