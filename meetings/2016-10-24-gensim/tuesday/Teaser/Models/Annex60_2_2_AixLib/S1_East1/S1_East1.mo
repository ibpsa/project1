within Annex60_2_2_AixLib.S1_East1;
model S1_East1
  "This is the simulation model of S1_East1"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.S1_East1.S1_East1_DataBase.S1_East1_base()
  ...
  AixLib.Building.Components.Weather.Weather weather(
    ...
    (nSurfaces=5,
    name={"90.0", "90", "180.0", "270.0", "270"},
    Azimut={-90.0, -90.0, 0.0, 90.0, 90.0},
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S1_East1//TSetS1_East1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S1_East1//AHU_S1_East1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:13,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S1_East1//InternalGains_S1_East1.mat"))
