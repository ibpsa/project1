within Annex60_2_2_AixLib.S2_East1;
model S2_East1
  "This is the simulation model of S2_East1"

	AixLib.Building.LowOrder.Multizone.MultizoneEquipped multizoneEquipped(
      buildingParam=Annex60_2_2_AixLib.S2_East1.S2_East1_DataBase.S2_East1_base()
  ...
  AixLib.Building.Components.Weather.Weather weather(
    ...
    (nSurfaces=5,
    name={"0.0", "90.0", "90", "270.0", "270"},
    Azimut={180.0, -90.0, -90.0, 90.0, 90.0},
    Tilt={90.0, 90.0, 45.0, 90.0, 45.0}))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableTSet(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S2_East1//TSetS2_East1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableAHU(
    ...
    columns=2:5,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S2_East1//AHU_S2_East1.mat"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable tableInternalGains(
    ...
    columns=2:13,
    fileName=Modelica.Utilities.Files.loadResource(
        "modelica://Annex60_2_2_AixLib/S2_East1//InternalGains_S2_East1.mat"))
