...
record S2_North_L1_LivingRoom "S2_North_L1_LivingRoom"
  extends AixLib.DataBase.Buildings.ZoneBaseRecord(
    ...
    Aw = {8.71, 0.0, 6.6, 2.22, 0.0},
    withWindows = true,
    weightfactorswindow = {0.4968625213918996, 0.0, 0.37649743297204785, 0.12664004563605247, 0.0},
    weightfactorswall = {0.08022271681794822, 0.0, 0.1385172272184129, 0.056491131164314375, 0.0},
