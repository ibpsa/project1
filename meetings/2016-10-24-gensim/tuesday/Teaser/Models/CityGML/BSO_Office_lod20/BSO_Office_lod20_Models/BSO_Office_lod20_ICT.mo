...
model BSO_Office_lod20_ICT
  "This is the simulation model of BSO_Office_lod20_ICT"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={6.28585662245e-05},
    CExt={124318726.531},
    alphaRad=0.670914542729,
    AInt=2772.0,
    alphaInt=7.24545454545,
    nInt=1,
    RInt={1.43215300333e-05},
    CInt={391889095.608},
    RWin=482.9832,
    RExtRem=0.00335624919988,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={4.9728, 1.5984, 4.9728, 1.5984, 0.0},
    AExt={67.2, 21.6, 67.2, 21.6, 126.0})
    "Thermal zone"
