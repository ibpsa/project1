...
model BSO_Office_lod20_Restroom
  "This is the simulation model of BSO_Office_lod20_Restroom"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={3.14292831122e-05},
    CExt={248637453.063},
    alphaRad=0.138138601636,
    AInt=30240.0,
    alphaInt=7.36666666667,
    nInt=1,
    RInt={1.49244457464e-06},
    CInt={3747148638.02},
    RWin=965.9664,
    RExtRem=0.00167812459994,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={9.9456, 3.1968, 9.9456, 3.1968, 0.0},
    AExt={134.4, 43.2, 134.4, 43.2, 252.0})
    "Thermal zone"
