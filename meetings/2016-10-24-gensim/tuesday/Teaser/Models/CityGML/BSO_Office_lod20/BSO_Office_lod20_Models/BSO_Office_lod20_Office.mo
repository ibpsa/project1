...
model BSO_Office_lod20_Office
  "This is the simulation model of BSO_Office_lod20_Office"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={2.51434264898e-06},
    CExt={3107968163.28},
    alphaRad=0.125896750598,
    AInt=415800.0,
    alphaInt=7.24545454545,
    nInt=1,
    RInt={9.54768668886e-08},
    CInt={58783364341.2},
    RWin=12074.58,
    RExtRem=0.000134249967995,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={124.32, 39.96, 124.32, 39.96, 0.0},
    AExt={1680.0, 540.0, 1680.0, 540.0, 3150.0})
    "Thermal zone"
