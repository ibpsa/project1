...
model BSO_Office_lod20_Meeting
  "This is the simulation model of BSO_Office_lod20_Meeting"
  ...
  thermalZoneTwoElements(
    ...
    CExt={248637453.063},
    alphaRad=0.245609220637,
    AInt=16632.0,
    alphaInt=7.24545454545,
    nInt=1,
    RInt={2.38692167222e-06},
    CInt={2351334573.65},
    RWin=965.9664,
