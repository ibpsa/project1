within CityGML.BSO_Office_lod20.BSO_Office_lod20_Models;
model BSO_Office_lod20_Storage
  "This is the simulation model of BSO_Office_lod20_Storage"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={8.38114216327e-06},
    CExt={932390448.985},
    alphaRad=0.150319113201,
    AInt=103950.0,
    alphaInt=7.24545454545,
    nInt=1,
    RInt={3.81907467555e-07},
    CInt={14695841085.3},
    RWin=3622.374,
    RExtRem=0.000447499893317,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={37.296, 11.988, 37.296, 11.988, 0.0},
    AExt={504.0, 162.0, 504.0, 162.0, 945.0})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTemp(
    n=5,
    wfGro=0.317267806121,
    wfWall={0.132148223175, 0.0424762145919, 0.132148223175, 0.0424762145919, 0.185687819194},
    wfWin={0.0559226213005, 0.0179751282752, 0.0559226213005, 0.0179751282752, 0.0},
    withLongwave=true,
    aExt=0.67858547486,
    alphaWallOut=20.0,
    alphaRad=5.0,
