...
model BSO_Office_lod20_Floor
  "This is the simulation model of BSO_Office_lod20_Floor"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={5.02868529796e-06},
    CExt={1553984081.64},
    alphaRad=0.226067188684,
    AInt=113400.0,
    alphaInt=7.42222222222,
    nInt=1,
    RInt={4.2461067047e-07},
    CInt={13144299538.3},
    RWin=6037.29,
    RExtRem=0.00026849993599,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={62.16, 19.98, 62.16, 19.98, 0.0},
    AExt={840.0, 270.0, 840.0, 270.0, 1575.0})
    "Thermal zone"
