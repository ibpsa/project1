...
model BSO_Office_lod10_Meeting
  "This is the simulation model of BSO_Office_lod10_Meeting"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={4.4662000134e-05},
    CExt={183684425.03},
    alphaRad=0.217041800643,
    AInt=12852.0,
    alphaInt=7.22941176471,
    nInt=1,
    RInt={3.04051516408e-06},
    CInt={1846640660.87},
    RWin=900.6984,
    RExtRem=0.00233945927156,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={7.4592, 4.7952, 7.4592, 4.7952, 0.0},
    AExt={100.8, 64.8, 100.8, 64.8, 126.0})
    "Thermal zone"
