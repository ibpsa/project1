within CityGML.BSO_Office_lod10.BSO_Office_lod10_Models;
model BSO_Office_lod10_Storage
  "This is the simulation model of BSO_Office_lod10_Storage"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.19098667024e-05},
    CExt={688816593.863},
    alphaRad=0.13252617801,
    AInt=80325.0,
    alphaInt=7.22941176471,
    nInt=1,
    RInt={4.86482426253e-07},
    CInt={11541504130.4},
    RWin=3377.619,
    RExtRem=0.000623855805749,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={27.972, 17.982, 27.972, 17.982, 0.0},
    AExt={378.0, 243.0, 378.0, 243.0, 472.5})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTemp(
    n=5,
    wfGro=0.22188480554,
    wfWall={0.13862901736, 0.0891186540169, 0.13862901736, 0.0891186540169, 0.129862863039},
    wfWin={0.058665170464, 0.0377133238697, 0.058665170464, 0.0377133238697, 0.0},
    withLongwave=true,
    aExt=0.670582716049,
    alphaWallOut=20.0,
    alphaRad=5.0,
