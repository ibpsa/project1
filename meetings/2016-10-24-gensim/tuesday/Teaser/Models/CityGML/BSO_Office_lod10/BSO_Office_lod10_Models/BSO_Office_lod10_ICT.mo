...
model BSO_Office_lod10_ICT
  "This is the simulation model of BSO_Office_lod10_ICT"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={8.93240002679e-05},
    CExt={91842212.5151},
    alphaRad=0.599112426036,
    AInt=2142.0,
    alphaInt=7.22941176471,
    nInt=1,
    RInt={1.82430909845e-05},
    CInt={307773443.479},
    RWin=450.3492,
    RExtRem=0.00467891854312,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={3.7296, 2.3976, 3.7296, 2.3976, 0.0},
    AExt={50.4, 32.4, 50.4, 32.4, 63.0})
    "Thermal zone"
