...
model BSO_Office_lod10_Office
  "This is the simulation model of BSO_Office_lod10_Office"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={3.57296001072e-06},
    CExt={2296055312.88},
    alphaRad=0.110928512736,
    AInt=321300.0,
    alphaInt=7.22941176471,
    nInt=1,
    RInt={1.21620606563e-07},
    CInt={46166016521.8},
    RWin=11258.73,
    RExtRem=0.000187156741725,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={93.24, 59.94, 93.24, 59.94, 0.0},
    AExt={1260.0, 810.0, 1260.0, 810.0, 1575.0})
    "Thermal zone"
