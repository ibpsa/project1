...
model BSO_Office_lod10_Restroom
  "This is the simulation model of BSO_Office_lod10_Restroom"
  ...
  thermalZoneTwoElements(
    ...
    CExt={183684425.03},
    alphaRad=0.122690093911,
    AInt=23184.0,
    alphaInt=7.35217391304,
    nInt=1,
    RInt={1.91533354923e-06},
    CInt={2921214397.64},
    RWin=900.6984,
