...
model BSO_Office_lod10_Floor
  "This is the simulation model of BSO_Office_lod10_Floor"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={7.14592002144e-06},
    CExt={1148027656.44},
    alphaRad=0.201894317049,
    AInt=86625.0,
    alphaInt=7.40909090909,
    nInt=1,
    RInt={5.47201556569e-07},
    CInt={10204639904.0},
    RWin=5629.365,
    RExtRem=0.00037431348345,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={46.62, 29.97, 46.62, 29.97, 0.0},
    AExt={630.0, 405.0, 630.0, 405.0, 787.5})
    "Thermal zone"
