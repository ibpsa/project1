...
model BSO_Office_lod11_Meeting
  "This is the simulation model of BSO_Office_lod11_Meeting"
  ...
  thermalZoneTwoElements(
    ...
    CExt={147194891.783},
    alphaRad=0.250301568154,
    AInt=8820.0,
    alphaInt=7.23333333333,
    nInt=1,
    RInt={4.44751453521e-06},
    CInt={1262320009.37},
    RWin=731.0016,
