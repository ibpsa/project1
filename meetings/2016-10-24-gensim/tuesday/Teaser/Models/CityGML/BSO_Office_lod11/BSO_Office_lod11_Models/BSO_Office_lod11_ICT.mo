...
model BSO_Office_lod11_ICT
  "This is the simulation model of BSO_Office_lod11_ICT"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.000111786745996},
    CExt={73597445.8916},
    alphaRad=0.682565789474,
    AInt=1470.0,
    alphaInt=7.23333333333,
    nInt=1,
    RInt={2.66850872112e-05},
    CInt={210386668.229},
    RWin=365.5008,
    RExtRem=0.00584959252519,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={1.6576, 3.3152, 1.6576, 3.3152, 0.0},
    AExt={22.4, 44.8, 22.4, 44.8, 49.0})
    "Thermal zone"
