...
model BSO_Office_lod11_Floor
  "This is the simulation model of BSO_Office_lod11_Floor"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={8.94293967969e-06},
    CExt={919968073.645},
    alphaRad=0.232319462586,
    AInt=59616.6666667,
    alphaInt=7.41232876712,
    nInt=1,
    RInt={7.98165611126e-07},
    CInt={6995185443.84},
    RWin=4568.76,
    RExtRem=0.000467967402015,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={20.72, 41.44, 20.72, 41.44, 0.0},
    AExt={280.0, 560.0, 280.0, 560.0, 612.5})
    "Thermal zone"
