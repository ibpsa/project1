...
model BSO_Office_lod11_Office
  "This is the simulation model of BSO_Office_lod11_Office"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={4.47146983984e-06},
    CExt={1839936147.29},
    alphaRad=0.12836374884,
    AInt=220500.0,
    alphaInt=7.23333333333,
    nInt=1,
    RInt={1.77900581408e-07},
    CInt={31558000234.4},
    RWin=9137.52,
    RExtRem=0.000233983701008,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={41.44, 82.88, 41.44, 82.88, 0.0},
    AExt={560.0, 1120.0, 560.0, 1120.0, 1225.0})
    "Thermal zone"
