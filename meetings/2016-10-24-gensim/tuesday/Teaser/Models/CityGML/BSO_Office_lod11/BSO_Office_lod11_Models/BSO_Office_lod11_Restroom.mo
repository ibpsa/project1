within CityGML.BSO_Office_lod11.BSO_Office_lod11_Models;
model BSO_Office_lod11_Restroom
  "This is the simulation model of BSO_Office_lod11_Restroom"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={5.58933729981e-05},
    CExt={147194891.783},
    alphaRad=0.141654340653,
    AInt=15941.3333333,
    alphaInt=7.35573770492,
    nInt=1,
    RInt={2.79660099323e-06},
    CInt={2000445251.29},
    RWin=731.0016,
    RExtRem=0.0029247962626,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={3.3152, 6.6304, 3.3152, 6.6304, 0.0},
    AExt={44.8, 89.6, 44.8, 89.6, 98.0})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTemp(
    n=5,
    wfGro=0.21580243884,
    wfWall={0.0770450748528, 0.154090149706, 0.0770450748528, 0.154090149706, 0.126303026881},
    wfWin={0.0326040141937, 0.0652080283874, 0.0326040141937, 0.0652080283874, 0.0},
    withLongwave=true,
    aExt=0.670043373494,
    alphaWallOut=20.0,
    alphaRad=5.0,
