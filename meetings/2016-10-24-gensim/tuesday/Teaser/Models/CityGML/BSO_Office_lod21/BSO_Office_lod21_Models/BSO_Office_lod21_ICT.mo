...
model BSO_Office_lod21_ICT
  "This is the simulation model of BSO_Office_lod21_ICT"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.000132978137787},
    CExt={60610254.0587},
    alphaRad=0.77850877193,
    AInt=1078.0,
    alphaInt=7.24545454545,
    nInt=1,
    RInt={3.68267915142e-05},
    CInt={152401314.959},
    RWin=274.1256,
    RExtRem=0.00701152276158,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={2.4864, 1.2432, 2.4864, 1.2432, 0.0},
    AExt={33.6, 16.8, 33.6, 16.8, 49.0})
    "Thermal zone"
