within CityGML.BSO_Office_lod21.BSO_Office_lod21_Models;
model BSO_Office_lod21_Storage
  "This is the simulation model of BSO_Office_lod21_Storage"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.77304183716e-05},
    CExt={454576905.44},
    alphaRad=0.177855711423,
    AInt=40425.0,
    alphaInt=7.24545454545,
    nInt=1,
    RInt={9.82047773712e-07},
    CInt={5715049310.95},
    RWin=2055.942,
    RExtRem=0.000934869701543,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={18.648, 9.324, 18.648, 9.324, 0.0},
    AExt={252.0, 126.0, 252.0, 126.0, 367.5})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTemp(
    n=5,
    wfGro=0.258283218233,
    wfWall={0.138317133872, 0.0691585669361, 0.138317133872, 0.0691585669361, 0.151165818285},
    wfWin={0.0585331872883, 0.0292665936442, 0.0585331872883, 0.0292665936442, 0.0},
    withLongwave=true,
    aExt=0.673735211268,
    alphaWallOut=20.0,
    alphaRad=5.0,
