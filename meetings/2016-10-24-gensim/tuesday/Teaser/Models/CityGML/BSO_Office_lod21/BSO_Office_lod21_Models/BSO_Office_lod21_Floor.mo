...
model BSO_Office_lod21_Floor
  "This is the simulation model of BSO_Office_lod21_Floor"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.06382510229e-05},
    CExt={757628175.734},
    alphaRad=0.26671675432,
    AInt=44100.0,
    alphaInt=7.42222222222,
    nInt=1,
    RInt={1.09185600978e-06},
    CInt={5111672042.66},
    RWin=3426.57,
    RExtRem=0.000560921820926,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={31.08, 15.54, 31.08, 15.54, 0.0},
    AExt={420.0, 210.0, 420.0, 210.0, 612.5})
    "Thermal zone"
