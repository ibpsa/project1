...
model BSO_Office_lod21_Restroom
  "This is the simulation model of BSO_Office_lod21_Restroom"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={6.64890688934e-05},
    CExt={121220508.117},
    alphaRad=0.163519115615,
    AInt=11760.0,
    alphaInt=7.36666666667,
    nInt=1,
    RInt={3.83771462051e-06},
    CInt={1457224470.34},
    RWin=548.2512,
    RExtRem=0.00350576138079,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={4.9728, 2.4864, 4.9728, 2.4864, 0.0},
    AExt={67.2, 33.6, 67.2, 33.6, 98.0})
    "Thermal zone"
