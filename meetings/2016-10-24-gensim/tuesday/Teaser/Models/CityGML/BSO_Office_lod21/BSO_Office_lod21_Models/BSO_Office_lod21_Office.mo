...
model BSO_Office_lod21_Office
  "This is the simulation model of BSO_Office_lod21_Office"
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={5.31912551147e-06},
    CExt={1515256351.47},
    alphaRad=0.14909701806,
    AInt=161700.0,
    alphaInt=7.24545454545,
    nInt=1,
    RInt={2.45511943428e-07},
    CInt={22860197243.8},
    RWin=6853.14,
    RExtRem=0.000280460910463,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={62.16, 31.08, 62.16, 31.08, 0.0},
    AExt={840.0, 420.0, 840.0, 420.0, 1225.0})
    "Thermal zone"
