within CityGML.BSO_Residential_lod10.BSO_Residential_lod10_Models;
model BSO_Residential_lod10_SingleDwelling
  "This is the simulation model of BSO_Residential_lod10_SingleDwelling"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[5](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.57079632679, 1.57079632679, 1.57079632679, 1.57079632679, 0.0},
    each lat = 0.8861990609344351,
    azi={3.141592653589793, -1.57079632679, 0.0, 1.57079632679, 0.0})
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5, UWin=3.00178213411)
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={6.89893126432e-05},
    CExt={170340076.301},
    alphaRad=2.04545454545,
    AInt=1300.0,
    ...
    CInt={153226592.82},
    RWin=4410.0,
    RExtRem=0.000373051727238,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={0, 0, 0, 0, 0},
    ATransparent={24.0, 36.0, 24.0, 36.0, 0.0},
    AExt={120.0, 180.0, 120.0, 180.0, 150.0})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTemp(
    n=5,
    wfGro=0.181819808448,
    wfWall={0.0861128750503, 0.129169312575, 0.0861128750503, 0.129169312575, 0.174055610419},
    wfWin={0.0427120411763, 0.0640680617645, 0.0427120411763, 0.0640680617645, 0.0},
    withLongwave=true,
    aExt=0.606666666667,
    alphaWallOut=20.0,
    alphaRad=5.0,
...
equation
  ...
  StopTime=31536000,
  Interval=3600));
end BSO_Residential_lod10_SingleDwelling;
