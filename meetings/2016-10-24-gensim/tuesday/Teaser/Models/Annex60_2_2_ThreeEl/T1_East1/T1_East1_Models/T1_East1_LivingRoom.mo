within Annex60_2_2_ThreeEl.T1_East1.T1_East1_Models;
model T1_East1_LivingRoom
  "This is the simulation model of T1_East1_LivingRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5, UWin=1.692268542081155)
  ...
  thermalZoneThreeElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00257142913813},
    CExt={6841047.38717},
    alphaRad=2.585389401416005,
    AInt=90.036,
    alphaInt=11.888768936869697,
    nInt=1,
    RInt={0.000780940130998},
    CInt={13242411.049},
    RWin=0.0352756412838,
    RExtRem=0.0600575470154,
    AFloor=43.6,
    alphaFloor=2.7000000000000006,
    nFloor=1,
    RFloor={0.000944415211829},
    RFloorRem=0.0521580184222,
    CFloor={3973933.62522},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.0, 0.5803865151981944, 0.08873007566860401, 0.24215333346459755, 0.08873007566860401},
    wfWin={0.1744452945677123, 0.605202754399388, 0.0, 0.22035195103289976, 0.0},
    withLongwave=true,
    aExt=0.7,
