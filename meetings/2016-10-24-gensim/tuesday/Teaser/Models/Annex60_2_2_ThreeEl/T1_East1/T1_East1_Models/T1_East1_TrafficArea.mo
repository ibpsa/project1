...
model T1_East1_TrafficArea
  ...
  thermalZoneThreeElements(
    ...
    nOrientations=4,
    AWin={1.0, 0.0, 2.08, 0.0},
    ATransparent={1.0, 0.0, 2.08, 0.0},
    AExt={4.964, 4.565, 15.084, 4.565}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.18540006138328055, 0.1256143804782425, 0.5633711776602343, 0.1256143804782425},
    wfWin={0.3246753246753246, 0.0, 0.6753246753246753, 0.0},
    withLongwave=true,
