...
model D1_North4_TrafficArea
  "This is the simulation model of D1_North4_TrafficArea"
  ...
  thermalZoneThreeElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00169188277059},
    CExt={10550784.1836},
    alphaRad=3.5795731762409875,
    AInt=31.442,
    alphaInt=12.156777558679474,
    nInt=1,
    RInt={0.00223285755634},
    CInt={5462388.948},
    RWin=0.37181663837,
    RExtRem=0.038790453635,
    AFloor=16.2,
    alphaFloor=2.7,
    nFloor=1,
    RFloor={0.002541759459},
    RFloorRem=0.140375901433,
    CFloor={1476553.31946},
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.6729742605955603, 0.09620160782316153, 0.0, 0.09620160782316153, 0.13462252375811679},
