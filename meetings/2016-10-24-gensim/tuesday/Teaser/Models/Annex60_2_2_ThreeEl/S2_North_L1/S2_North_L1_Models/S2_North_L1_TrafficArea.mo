...
model S2_North_L1_TrafficArea
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[3](
    each outSkyCon=true,
    each outGroCon=true,
    til={0.7853981633974483, 1.5707963267948966, 0.7853981633974483},
    each lat = 0.8861990609344351,
    azi={3.141592653589793, 0.0, 0.0})
  ...
  thermalZoneThreeElements(
    ...
    nOrientations=3,
    AWin={0.0, 0.64, 0.0},
    ATransparent={0.0, 0.64, 0.0},
    AExt={3.85, 10.14, 3.85}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=3,
    wfGro=0.0,
    wfWall={0.28665482995554015, 0.4266903400889197, 0.28665482995554015},
    wfWin={0.0, 1.0, 0.0},
    withLongwave=true,
    aExt=0.7,
    alphaWallOut=20.0,
