within Annex60_2_2_ThreeEl.T1_North1.T1_North1_Models;
model T1_North1_LivingRoom
  "This is the simulation model of T1_North1_LivingRoom"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[5](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.7853981633974483, 1.5707963267948966, 1.5707963267948966, 0.7853981633974483},
    each lat = 0.8861990609344351,
    azi={3.141592653589793, 3.141592653589793, -1.5707963267948966, 0.0, 0.0})
  ...
  thermalZoneThreeElements(
    ...
    nOrientations=5,
    AWin={7.91, 0.0, 2.28, 2.88, 0.0},
    ATransparent={7.91, 0.0, 2.28, 2.88, 0.0},
    AExt={21.686, 4.5, 0.0, 9.048, 4.5}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.5803865151981944, 0.08873007566860401, 0.0, 0.24215333346459755, 0.08873007566860401},
    wfWin={0.605202754399388, 0.0, 0.1744452945677123, 0.22035195103289976, 0.0},
    withLongwave=true,
    aExt=0.7,
