within Annex60_2_2_ThreeEl.S1_North_L1.S1_North_L1_Models;
model S1_North_L1_BedRoom
  "This is the simulation model of S1_North_L1_BedRoom"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[5](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 0.7853981633974483, 1.5707963267948966, 0.7853981633974483, 1.5707963267948966},
    each lat = 0.8861990609344351,
    azi={3.141592653589793, 3.141592653589793, 0.0, 0.0, 1.5707963267948966})
  ...
  thermalZoneThreeElements(
    ...
    nOrientations=5,
    AWin={2.0, 0.0, 0.0, 0.0, 5.76},
    ATransparent={2.0, 0.0, 0.0, 0.0, 5.76},
    AExt={21.212, 21.3, 12.068, 21.3, 25.88}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.23426876695613386, 0.17331368439739586, 0.13328094850210367, 0.17331368439739586, 0.28582291574697083},
    wfWin={0.25773195876288657, 0.0, 0.0, 0.0, 0.7422680412371134},
    withLongwave=true,
