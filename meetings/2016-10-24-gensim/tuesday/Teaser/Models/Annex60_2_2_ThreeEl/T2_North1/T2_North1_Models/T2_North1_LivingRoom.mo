within Annex60_2_2_ThreeEl.T2_North1.T2_North1_Models;
model T2_North1_LivingRoom
  "This is the simulation model of T2_North1_LivingRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.4647811969825184, 0.17064960555056896, 0.0, 0.1939195919163436, 0.17064960555056896},
    wfWin={0.6052027543993881, 0.0, 0.1744452945677123, 0.22035195103289978, 0.0},
    withLongwave=true,
    aExt=0.7,
