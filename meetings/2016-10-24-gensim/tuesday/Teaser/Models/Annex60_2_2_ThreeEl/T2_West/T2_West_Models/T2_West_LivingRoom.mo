within Annex60_2_2_ThreeEl.T2_West.T2_West_Models;
model T2_West_LivingRoom
  "This is the simulation model of T2_West_LivingRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5, UWin=5.003248862897985)
  ...
  thermalZoneThreeElements(
    ...
    nOrientations=5,
    AWin={2.28, 2.88, 0.0, 7.91, 0.0},
    ATransparent={2.28, 2.88, 0.0, 7.91, 0.0},
    AExt={0.0, 9.048, 4.5, 21.686, 4.5}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.0, 0.1939195919163436, 0.17064960555056896, 0.4647811969825184, 0.17064960555056896},
    wfWin={0.1744452945677123, 0.22035195103289978, 0.0, 0.6052027543993881, 0.0},
    withLongwave=true,
    aExt=0.7,
