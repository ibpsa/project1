...
model T1_West_TrafficArea
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[4](
    ...
    azi={-1.5707963267948966, -1.5707963267948966, 1.5707963267948966, 1.5707963267948966})
  ...
  thermalZoneThreeElements(
    ...
    nOrientations=4,
    AWin={2.08, 0.0, 1.0, 0.0},
    ATransparent={2.08, 0.0, 1.0, 0.0},
    AExt={15.084, 4.565, 4.964, 4.565}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.5633711776602343, 0.1256143804782425, 0.18540006138328055, 0.1256143804782425},
    wfWin={0.6753246753246753, 0.0, 0.3246753246753246, 0.0},
    withLongwave=true,
