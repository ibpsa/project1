within Annex60_2_2_ThreeEl.T1_West.T1_West_Models;
model T1_West_LivingRoom
  "This is the simulation model of T1_West_LivingRoom"
  ...
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.0, 0.24215333346459755, 0.08873007566860401, 0.5803865151981944, 0.08873007566860401},
    wfWin={0.1744452945677123, 0.22035195103289976, 0.0, 0.605202754399388, 0.0},
    withLongwave=true,
    aExt=0.7,
