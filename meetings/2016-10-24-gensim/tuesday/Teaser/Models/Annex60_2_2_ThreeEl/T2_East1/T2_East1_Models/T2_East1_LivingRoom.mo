within Annex60_2_2_ThreeEl.T2_East1.T2_East1_Models;
model T2_East1_LivingRoom
  "This is the simulation model of T2_East1_LivingRoom"
  ...
  Annex60.BoundaryConditions.SolarIrradiation.DiffusePerez HDifTil[5](
    each outSkyCon=true,
    each outGroCon=true,
    til={1.5707963267948966, 1.5707963267948966, 0.7853981633974483, 1.5707963267948966, 0.7853981633974483},
    each lat = 0.8861990609344351,
    azi={3.141592653589793, -1.5707963267948966, -1.5707963267948966, 1.5707963267948966, 1.5707963267948966})
    "Calculates diffuse solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,20},{-48,40}})));
  Annex60.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[5](
    til={1.5707963267948966, 1.5707963267948966, 0.7853981633974483, 1.5707963267948966, 0.7853981633974483},
    each lat = 0.8861990609344351,
    azi={3.141592653589793, -1.5707963267948966, -1.5707963267948966, 1.5707963267948966, 1.5707963267948966})
    "Calculates direct solar radiation on titled surface for all directions"
    annotation (Placement(transformation(extent={{-68,52},{-48,72}})));
  Annex60.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=5, UWin=5.003248862897986)
  ...
  thermalZoneThreeElements(
    ...
    ratioWinConRad=0.07,
    nExt=1,
    RExt={0.00128726721472},
    CExt={5358238.14891},
    alphaRad=2.585389401416005,
    AInt=90.036,
    alphaInt=11.888768936869697,
    nInt=1,
    RInt={0.000863206194305},
    CInt={16314153.2288},
    RWin=0.00535577658761,
    RExtRem=0.0098011121503,
    AFloor=43.6,
    alphaFloor=2.7000000000000006,
    nFloor=1,
    RFloor={0.000725560391745},
    RFloorRem=0.00313240481269,
    CFloor={6435655.31076},
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    floorRC(thermCapExt(each der_T(fixed=true))),
    nOrientations=5,
    AWin={2.28, 7.91, 0.0, 2.88, 0.0},
    ATransparent={2.28, 7.91, 0.0, 2.88, 0.0},
    AExt={0.0, 21.686, 4.5, 9.048, 4.5}) "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Annex60.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=5,
    wfGro=0.0,
    wfWall={0.0, 0.4647811969825184, 0.17064960555056896, 0.1939195919163436, 0.17064960555056896},
    wfWin={0.17444529456771227, 0.6052027543993879, 0.0, 0.22035195103289973, 0.0},
    withLongwave=true,
    aExt=0.7,
  ...
  *39.734)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant alphaWin(k=326.75)
