...
def D1_North(prj, name):
    ...
    tz1.use_conditions.load_use_conditions("Group Office (between 2 and 6 employees)")
    ...
    tz2.use_conditions.load_use_conditions("Group Office (between 2 and 6 employees)")
    ...
    tz3.use_conditions.load_use_conditions("Group Office (between 2 and 6 employees)")
...
if __name__ == '__main__':
    ...
    Save new TEASER XML
    '''
    prj.save_project("Annex60_2_2_Offices")
