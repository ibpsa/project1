...
model A1NorthBoiler
  ...
  *44.44)
  ...
  Modelica.Blocks.Sources.Constant setTemp(k=273.15 + 20)
  ...
  Annex60.Controls.Continuous.LimPID
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={-58,186})));
  Modelica.Blocks.Sources.Constant setTemp1(k=273.15 + 20)
    annotation (Placement(transformation(extent={{-114,210},{-94,230}})));
...
equation
  ...
  connect(sanitaryRooms.TAir, conPI2.u_m) annotation (Line(points={{-29,-80},{
          ...
          {0,0,127}));
  connect(setTemp.y, conPI1.u_s) annotation (Line(points={{-105,-10},{-92,-10},
          {-92,0},{-76,0}}, color={0,0,127}));
  connect(setTemp.y, conPI2.u_s) annotation (Line(points={{-105,-10},{-92,-10},
          {-92,6},{-140,6},{-140,0},{-150,0}}, color={0,0,127}));
  ...
  connect(livingRoom.TAir, conPI3.u_m) annotation (Line(points={{207,146},{210,
        ...
        color={0,0,127}));
  connect(setTemp1.y, conPI3.u_s)
    annotation (Line(points={{-93,220},{-58,220},{-58,198}}, color={0,0,127}));
