...
model A1NightSetback
  ...
  *44.44)
  ...
  Modelica.Blocks.Sources.Pulse y(
    ...
    offset=273.15 + 15,
    startTime=21600,
    amplitude=5)  "Input signal"
                 annotation (Placement(transformation(extent={{-132,-16},{-112,
            4}})));
  Modelica.Blocks.Sources.Pulse y1(
    ...
    startTime=21600,
    amplitude=5)  "Input signal"
                 annotation (Placement(transformation(extent={{-130,212},{-110,
            232}})));
equation
  ...
  connect(y.y, conPI1.u_s) annotation (Line(points={{-111,-6},{-102,-6},{-102,
          -8},{-94,-8},{-94,0},{-76,0}}, color={0,0,127}));
  connect(y.y, conPI2.u_s) annotation (Line(points={{-111,-6},{-102,-6},{-102,
          10},{-142,10},{-142,0},{-150,0}}, color={0,0,127}));
  connect(y1.y, conPI3.u_s) annotation (Line(points={{-109,222},{-58,222},{-58,
          198}}, color={0,0,127}));
  annotation (
